...
class DynamicDivergence(Strategy):
    ...
    def init(self):
        ...
        # Swing detection
        self.price_swing_high = self.I(talib.MAX, self.data.High, timeperiod=self.swing_window)
        self.price_swing_low = self.I(talib.MIN, self.data.Low, timeperiod=self.swing_window)
        self.obv_swing_high = self.I(talib.MAX, self.obv, timeperiod=self.swing_window)
        self.obv_swing_low = self.I(talib.MIN, self.obv, timeperiod=self.swing_window)
