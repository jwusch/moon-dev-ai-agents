...
#                     print(f"🌙✨ LONG SIGNAL! Size: {position_size} @ {current_close:.2f}")
#                     print(f"   SL: {current_close - stop_distance:.2f}, TP: {self.take_profit:.2f} 🚀")
#             
#             # Short entry
...
#                              sl=current_close + stop_distance,
#                              tag='Short Entry')
#                     self.trailing_low = current_close
#                     self.take_profit = current_close - 3 * atr_value
#                     print(f"🌙✨ SHORT SIGNAL! Size: {position_size} @ {current_close:.2f}")
#                     print(f"   SL: {