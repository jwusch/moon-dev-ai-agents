...
#         print("🌙 Initializing Moon Dev's Quantum Indicators...")'
        ...
        self.std = self.I(talib.STDDEV, self.data.Close, 20, name='STDDEV 20')
        ...
        self.ma_200 = self.I(talib.SMA, self.data.Close, 200, name='SMA 200')
    ...
    def next(self):
        ...
        if not self.position:
            ...
            cmf_cross = crossover(self.cmf, 0)[-1]
