...
# Here's the implementation of the VolCompress Breakout strategy for backtesting.py:
# 
# ```python
...
#         self.bbw_percentile = self.I(lambda x: x.rolling(self.bbw_percentile_window).apply(
#             lambda y: (y <= y[-1]).mean() * 100, bbw)
#         
...
#                         print(f"🚀 LONG Signal: {entry_price:.2f} | Size: {size} | SL: {sl_price:.2