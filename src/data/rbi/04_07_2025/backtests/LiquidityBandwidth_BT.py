...
#         self.bb_upper = self.I(talib.BBANDS, self.data.Close, 20, 2, 2, name='BB_UPPER')[0]
#         self.bb_lower = self.I(talib.BBANDS, self.data.Close, 20, 2, 2, name='BB_LOWER')[2]
#         self.bb_mid = self.I(talib.SMA, self.data.Close, 20, name='BB_MID')
#         
