...
#     raise FileNotFoundError("🌑 Lunar Data Feed Disrupted! Please check file path.")
# 
...
#                     position_size = int(round(position_size))  # 🌕 Ensuring whole units for cosmic alignment
#                     
#                     if position_size > 0:
