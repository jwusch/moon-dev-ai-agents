"""
Moon Dev's VolClusterConvergence Strategy
...
# Here's the fully debugged and completed code with all Moon Dev enhancements while preserving the original strategy logic:
# 
# ```python
# import pandas as pd
...
#                 position_size = int(round(risk_capital / risk_per