"""
Moon Dev's VolDivergenceSurge Strategy
...
# Here's the debugged and fixed version of your VolDivergenceSurge strategy with proper position sizing and technical corrections:
# 
# ```python
# import numpy as np
# import pandas as pd
...
#         return talib.EMA(force, timeperiod=13)
# 
...
# 
#         # Entry conditions
#         price_high = talib.MAX(self.data.High, timeperiod=self.lookback_divergence)[-1]
#         efi_high = talib.MAX(self.efi, timeperiod=self.lookback_divergence)[-1]
#         prev_price_high = talib.MAX(self.data.High, timeperiod=self.lookback_divergence)[-self.lookback_divergence-1]
#         prev_efi_high = talib.MAX(self.efi, timeperiod=self.lookback_divergence)[-self.lookback_divergence-1]
# 
#         long_conditions = (
