...
#                 if bearish_div:
#                     print(f"🌑 Bearish divergence detected! Price Swing High: {self.swing_high_price[-1]:0.2f}, MACD Swing High: {self.swing_high_macd[-1]:0.2f}")
...
#                 if bullish_div:
#                     print(f"🚀 Bullish divergence detected! Price Swing Low: {self.swing_low_price[-1]:0.2f}, MACD Swing Low: {self.swing_low_macd[-1]:0.2f}")
