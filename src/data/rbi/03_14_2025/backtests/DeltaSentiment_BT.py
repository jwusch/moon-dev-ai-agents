...
#         print(f"\n🌙 [BAR {len(self.data)}] Price: {current_close:0.2f}")
#         print(f"📈 Spread: {spread_now:0.2f} (Prev: {spread_prev:0.2f})")
#         print(f"💧 Volume: {current_volume:0.2f} vs MA: {volume_ma:0.2f}")
# 
#         # Risk calculations
#         equity = self.equity
#         position_size = 0
...
# 
# print("🔄 Running backtest with Moon Dev settings...")
# bt = Backtest(data, DeltaSentiment, cash=1_000_000