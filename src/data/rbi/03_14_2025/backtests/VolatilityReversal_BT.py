...
#             print(f"🌑🌑 MOON DEV EMERGENCY: Max Drawdown Breached {drawdown:0.2%}! Stopping trading.")
#             self.position.close()
#             return
# 
#         # Entry Logic 🌙✨
...
#                         print(f"🌙✨ MOON DEV ENTRY: Long {position_size} @ {self.data.Open[-1]:0.2f} | SL: {sl_level:0.2f}")
# 
#         # Exit Logic 🚀🌊
#         else:
#             # Price channel exit
