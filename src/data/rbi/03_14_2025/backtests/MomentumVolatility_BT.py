"""
Moon Dev's MomentumVolatility Strategy
...
# 
#         # ✨ DEBUG PRINTING ✨
#         print((f"🌙 RSI: {rsi:0.1f} | VIX: {vix:0.1f} | "
#                f"Price/SMA: {price:0.1f}/{sma:0.1f} | Corr: {corr:0.2f}"))
# 
#         # 🚀 ENTRY LOGIC 🚀
...
#                                f"Buy {position_size} @ {price:0.1f} "
#                                f"SL: {stop_price:0.1f}"))
# 
#         # 🌑 EXIT LOGIC 🌑
#         else:
#             if any([
...
#             ]):
#                 self.position.close()
#                 print(f"🌑 MOON LANDING! Exit @ {self.data.Close[-1]:0.1f}")
# 
# # 🌙 BACKTEST EXECUTION 🌙
...
#     
#     # Launch moon mission
#     bt = Backtest(data, MomentumVolatility, cash=1_000_000, commission=0.002)
#     stats = bt.run()
#     
