"""
Moon Dev's VolumeSkewDivergence Strategy
...
#                     print(f"🚀 MOON DEV LONG SIGNAL 🌙 | Size: {position_size} | Entry: {entry_price:0.2f} | SL: {stop_loss:0.2f} | TP: {take_profit:0.2f}")
# 
...
#                     print(f"🌑 MOON DEV SHORT SIGNAL 🌙 | Size: {position_size} | Entry: {entry_price:0.2f} | SL: {stop_loss:0.2f} | TP: {take_profit:0.2f}")
# 
#         # Exit Conditions for Open Positions
#         if self.position.is_long and current_skew < prev_skew:
#             self.position.close()
#             print(f"🌙 VOLUME SKEW REVERSAL | Closing LONG at {current_close:0.2f} ✨")
# 
#         if self.position.is_short and current_skew < prev_skew:
#             self.position.close()
#             print(f"🌙 VOLUME SKEW REVERSAL | Closing SHORT at {current_close:0.2f} ✨")
# 
