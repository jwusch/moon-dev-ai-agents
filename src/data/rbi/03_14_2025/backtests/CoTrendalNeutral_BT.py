"""
Moon Dev's CoTrendalNeutral Strategy
...
#         self.atr_ma = self.I(talib.SMA, self.atr, 14, name='ATR_MA')
#         
#         # Swing Levels
...
#                         print(f"🌙🚀 MOON SHOT LONG! Entry: {price:0.2f}, Size: {position_size}, SL: {sl:0.2f}, TP: {tp:0.2f}")
# 
#             # Short Entry Logic        
...
#                         print(f"🌙📉 BLACK HOLE SHORT! Entry: {price:0.2f}, Size: {position_size}, SL: {sl:0.2f}, TP: {tp:0.2f}")
# 
#         else:
#             # Moon Gravity Exit Check 🌕
#             if self.position.is_long and (crossover(self.sma50, self.data.Close) or vol_increasing):
#                 self.position.close()
#                 print(f"🌕🌌 LONG GRAVITY EXIT at {price:0.2f}")
#             elif self.position.is_short and (crossover(self.data.Close, self.sma50) or vol_decreasing):
#                 self.position.close()
#                 print(f"🌕🌠 SHORT GRAVITY EXIT at {price:0.2f}")
# 
# # Launch Backtest 🚀
# bt = Backtest(data, CoTrendalNeutral,