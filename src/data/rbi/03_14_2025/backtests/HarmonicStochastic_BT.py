"""
Moon Dev's HarmonicStochastic Strategy
...
#                         print(f"🌙✨ BULLISH BREAKOUT! LONG {position_size} @ {current_close:0.2f}")
#                         print(f"   🛡️ SL: {sl:0.2f} | 🎯 TP: {tp:0.2f} | 📏 ATR: {atr_value:0.2f}")
# 
...
#                         print(f"🌙✨ BEARISH BREAKDOWN! SHORT {position_size} @ {current_close:0.2f}")
#                         print(f"   🛡️ SL: {sl:0.2f} | 🎯 TP: {tp:0.2f} | 📏 ATR: {atr_value:0.2f}")
# 
#         # 💫 EXIT LOGIC
#         else:
...
#                 self.position.close()
#                 print(f"🌙💎 CLOSING LONG POSITION | RSI REVERSAL @ {current_close:0.2f}")
#                 
#             elif self.position.is_short and crossover(self.rsi, 30):
#                 self.position.close()
#                 print(f"🌙💎 CLOSING SHORT POSITION | RSI REVERSAL @ {current_close:0.2f}")
# 
# # 🌍 DATA PREPARATION
