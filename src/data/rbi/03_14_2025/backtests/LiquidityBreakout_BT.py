"""
Moon Dev's LiquidityBreakout Strategy
...
#         print(f"\n🌕 Moon Dev Debug | Close: {current_close:0.2f} | Volume: {current_volume:0.2f}")
#         print(f"✨ Swing High: {self.swing_high[-1]:0.2f} | Swing Low: {self.swing_low[-1]:0.2f}")
#         print(f"📈 Trend Filter SMA50: {self.sma50[-1]:0.2f}")
# 
...
#                         print(f"🎯 TP: {tp_price:0.2f} | 🛑 SL: {sl_price:0.2f}")
# 
...
# 
# # Run backtest 🚀
# bt = Backtest(data, LiquidityBreakout, cash=1_000_000, commission=0.002)
# stats = bt.run()
# print("\n🌕🌖🌗🌘🌑🌒🌓🌔🌕 MO