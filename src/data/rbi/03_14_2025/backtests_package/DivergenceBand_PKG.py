...
# I'll help you fix the code by removing all `backtesting.lib` imports and replacing any usage of `crossover` and `crossunder` with proper alternatives. Here's the corrected version:
# 
# ```python
# import pandas as pd
# import talib
...
#                 self.last_swing_low_price is not