...
# Here's the fixed and debugged code with Moon Dev themed debug prints and proper position sizing implementation:
# 
# ```python
# import pandas as pd
# import talib
...
#                 distance_pct = (self.last_swing_low_price - current