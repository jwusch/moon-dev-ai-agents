"""
Moon Dev's DynamicDivergence Strategy
...
#                 rsi_prev <= 50 and rsi_current > 50):  # Manual crossover detection
#                 
...
#                     print(f"🌙 Position Size: {position_size} units | SL: {stop_loss:.2f} | TP: {take_profit:.2f}")
