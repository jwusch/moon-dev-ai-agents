"""
Moon Dev's ChaikinBands Strategy
...
#             if self.position.is_long and self.chaikin[-2] > 0 and self.chaikin[-1] < 0:
#                 self.position.close()
#                 print(f"🌗 MOON PHASE SHIFT 🌗 | Closing Long at {current_close:.2f}")
#                 
#             elif self.position.is_short and self.chaikin[-2] < 0 and self.