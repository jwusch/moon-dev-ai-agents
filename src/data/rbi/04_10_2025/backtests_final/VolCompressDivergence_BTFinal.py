...
#                     position_size = int(round(position_size))  # 🌙 Fixed: Round to whole units
#                     
#                     if position_size > 0:
#                         self.buy(
#                             size=position_size,
...
#         # Exit Logic
#         else:
#             # VIX crosses below its SMA20 - proper crossover implementation
#             if (self.vix[-2] > self.vix_sma20[-2]) and (self.vix[-1] < self.vix_sma20[-1]):
#                 self.position.close()
