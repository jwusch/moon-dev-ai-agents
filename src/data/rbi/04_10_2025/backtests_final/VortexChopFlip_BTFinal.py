"""
Moon Dev's VortexChopFlip Strategy
...
#                     )
#                     print(f"🌙🚀 MOON DEV LONG SIGNAL DETECTED! Entry: {self.data.Close[-1]:.2f}, Size: {position_size}, SL: {self.data.Close[-1]-1.5*atr_val:.2f}, TP: {self.data.Close[-1]+3*atr_val:.2f}")
#             
#             # Short entry logic 🌙📉
