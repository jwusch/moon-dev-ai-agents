"""
Moon Dev's LiquidationSpikeEngulf Strategy
...
#     risk_percent = 0.01          # 1% risk per trade (converted to fraction)
#     atr_period = 14
...
#             risk_amount = self.equity * self.risk_percent  # risk_percent is now fraction
