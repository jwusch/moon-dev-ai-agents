...
#                                         crossover(-self.raw_imbalance, self.lower_band)):
#                 self.position.close()
#                 print(f"🌕 MOON EXIT LONG at {self.data.Close[-1]:.2f} - Reached Cosmic Resistance! 🚀")
#                 
#             elif self.position.is_short and (self.data.Close[-1] <= self.swing_low[-1] or
#                                            crossover(self.raw_imbalance, self.upper_band)):
#                 self.position.close()
#                 print(f"🌕 MOON EXIT SH