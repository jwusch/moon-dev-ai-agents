...
class VoltaicSqueeze(Strategy):
    ...
    def init(self):
        ...
        self.bb_width_avg = self.I(talib.SMA, bb_width, 10, name='BBW_MA10')
        
        # Volume-Weighted MACD
        vw_price = close * self.data.Volume
        macd, macdsignal, macdhist = talib.MACD(vw_price, 12, 26, 9)
        ...
        self.swing_high = self.I(talib.MAX, high, 20, name='SWING_HIGH')
        self.swing_low = self.I(talib.MIN, low, 20, name='SWING_LOW')
