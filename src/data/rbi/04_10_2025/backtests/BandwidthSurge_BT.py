...
#     def next(self):
#         if self.position:
#             return  # Moon Dev Rule: Single position at a time 🌙
# 
...
#         # print(f"BBW: {bbw:.4f} | 6M Low: {bbw_min:.4f} | Vol: {volume:.0f} vs MA: {vol_ma:.0f}")
# 
