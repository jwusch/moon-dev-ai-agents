"""
Moon Dev's LiquidationConvergence Strategy
...
#             if (crossover(self.data.Close, self.swing_high) and 
#                 crossover(self.efi, 0)):
#                 
...
#             elif (crossunder(self.data.Close, self.swing_low) and 
#                   crossunder(self.efi, 0)):
#                 
...
# 
# # Run backtest with 1,000,000 capital 🌙🚀
# bt = Backtest(data, LiquidationConvergence, cash=1_000_000)
# stats = bt.run()
# 
