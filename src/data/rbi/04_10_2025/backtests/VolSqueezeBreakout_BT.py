...
from backtesting.lib import TrailingStopLoss
    ...
    def next(self):
        ...
        # Exit logic
            ...
            if self.position.is_long:
                ...
                if not hasattr(self.position, 'peak'):
                    self.position.peak = self.data.High[-1]
                else:
                    self.position.peak = max(self.position.peak, self.data.High[-1])
