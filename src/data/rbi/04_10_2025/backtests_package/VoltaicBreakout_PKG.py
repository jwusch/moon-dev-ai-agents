...
# Here's the fixed code with proper Moon Dev themed indicators and debug prints, ensuring no backtesting.lib imports are used:
# 
# ```python
# # -*- coding: utf-8 -*-
# import pandas as pd
...
#                 return
#             size = int(round((self.equity * self.risk_percent) / risk))
#             print(f"🌙🚀 BEARISH BREAKDOWN! Shorting {size} @ {self