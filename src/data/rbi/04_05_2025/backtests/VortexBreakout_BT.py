...
#             stop_loss = self.atr[-1] * self.atr_multiplier
...
#                 new_sl = peak - self.atr[-1] * self.atr_multiplier
#                 trade.sl = max(new_sl, trade.sl or 0)
#             else:
#                 # Short trailing stop 🌑
#                 trough = min(self.data.Low[trade.entry_bar:-1], default=trade.entry_price)
#                 new_sl = trough + self.atr[-1] *