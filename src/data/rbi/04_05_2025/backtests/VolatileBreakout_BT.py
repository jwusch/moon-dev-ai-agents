...
#         self.cons_high = self.I(talib.MAX, self.data.High, 14, name='Cons_High')
#         self.cons_low = self.I(talib.MIN, self.data.Low, 14, name='Cons_Low')
#         
...
# bt = Backtest(data, VolatileBreakout, cash=1_000_000, commission=.