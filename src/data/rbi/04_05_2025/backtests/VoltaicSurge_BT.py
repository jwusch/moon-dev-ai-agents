"""
Moon Dev's VoltaicSurge Strategy
...
#         print(f"🌙 Current Price: {price} | ADX: {adx:.1f} | BB%: {bb_width*100:.2f}%/{bb_pctl*100:.2f}% ✨")
# 
...
#                 print(f"🌙🚀 LONG ENTRY @ {price} | Size: {position_size} | SL: {self.initial_stop} ✨")
# 
...
#                 print(f"🌙🚀 SHORT ENTRY @ {price} | Size: {position_size} | SL: {self.initial_stop} ✨")
# 
#         else:
#             # Position management
#             if self.position.is_long:
#                 # Update trailing stop
#                 self.highest_high = max(self.highest