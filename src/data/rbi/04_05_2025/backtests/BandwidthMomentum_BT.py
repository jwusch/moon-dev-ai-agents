...
#                                name='Bandwidth')
#         self.bandwidth_sma = self.I(talib.SMA, self.bandwidth, 20, name='Bandwidth SMA')
#         
#         # Momentum indicators
#         self.cmo = self.I(talib.CMO, self.data.Close, 14, name='CMO(14)')
#         self.signal_line = self.I(talib.SMA, self.cmo, 9, name='Signal Line')
#         
...
#             if crossover(current_cmo, current_signal) and contraction:
...
#             elif crossover(-current_cmo, -current_signal) and contraction:
#                 entry_price = self.data.Open[-1]
...
#                         self.entry_bandwidth = self.bandwidth[-1]
#                         print(f"🌑⚡ BEARISH ALERT! Short entry at {entry_price:.2f} "
#                               f"Size: {position_size} contracts