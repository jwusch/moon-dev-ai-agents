...
class LiquidationCluster(Strategy):
    ...
    def next(self):
        ...
        if self.position:
            ...
            # Time-based exit
            elif (len(self.data) - self.entry_bar) >= self.max_trade_duration:
                print("⏰ TIME OUT: 12h trade duration reached")
                self.position.close()

# Data preprocessing
data_path = "/Users/md/Dropbox/dev/github/moon-dev-ai-agents-for-trading/src/data/rbi/BTC-USD-15m"