"""
Moon Dev's VwapForceBreakout Strategy
...
#                 and (force_value > 0.5 or crossover(self.force_index, self.force_index_sma)) \
#                 and volume_filter \
...
#                 and (force_value < -0.5 or crossunder(self.force_index, self.force_index_sma)) \
#                 and volume_filter \
...
#                 
#                 position_size = int(round(risk_amount / risk_per_unit))
#                 take_profit = current_close - 2 * (stop_loss - current_close)
#                 
#                 if position_size > 0:
...
#                     print(f"🌒 COMET STRIKE: Short {position_size} units at {current_close}