"""
Moon Dev's LiquidityBandReversion Strategy
...
#         self.middle = self.I(talib.SMA, close, self.bb_period)
#         self.std = self.I(talib.STDDEV, close, self.bb_period)
...
#         
#         # Liquidity Zones
#         self.swing_high = self.I(talib.MAX, high, self.swing_window, name='SWING_HIGH')
#         self.swing_low = self.I(talib.MIN, low, self.swing_window, name='SWING_LOW')
#         
#         # Volume Validation
#         self.vol_ma = self.I(talib.SMA, self.data.Volume, self.swing_window)
#         
