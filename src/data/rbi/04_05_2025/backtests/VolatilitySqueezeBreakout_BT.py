...
#         self.atr_kc = self.I(talib.ATR, self.data.High, self.data.Low, self.data.Close, 20)
...
#         self.kc_width_low = self.I(talib.MIN, self.kc_width, 20)
...
# 
#     def _enter_trade(self, direction, entry_price, stop_price):