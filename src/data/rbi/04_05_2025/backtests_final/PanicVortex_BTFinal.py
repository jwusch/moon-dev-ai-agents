"""
Moon Dev's PanicVortex Strategy
...
#         self.vix_upper, self.vix_sma, _ = self.I(talib.BBANDS, self.vix, 20, 2, 2, name='VIX_BBANDS')
...
#                         print(f"🚀 MOON DEV BUY {position_size} units @ {price:.2f} | SL: {sl:.2f} 🌕")
# 
#         # Exit Logic 🛑
#         elif self.position:
