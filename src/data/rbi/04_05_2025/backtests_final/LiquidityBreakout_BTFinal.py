...
#                         print(f"🌙🚀 BULLISH BREAKOUT! Buying {position_size} units @ {price:.2f}")
#                         print(f"   SL: {sl:.2f} | TP: {tp:.2f} | ATR: {atr:.2f} ✨")
#             
...
#                         print(f"🌙💥 BEARISH BREAKDOWN! Selling {position_size} units @ {price:.2f}")
#                         print(f"