...
#         
#         # ✨ Dynamic ATR Percentile Calculation (Pandas Rolling)
...
#                 price > self.sma[-1]):
#                 
#                 # 🌕 Risk Management Calculation (Pure Math)
...
#         else:
#             # Stop Loss Check (Direct Array Access)
...
# bt = Backtest(data, VolatilityThreshold, cash=1_000_000, commission=.002, exclusive_orders=True)
# stats = bt.run()
# 
