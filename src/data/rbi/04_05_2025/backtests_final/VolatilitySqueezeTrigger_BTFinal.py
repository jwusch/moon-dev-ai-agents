...
#         self.kvo = self.I(lambda x: x, kvo_df.iloc[:,0], name='KVO')
...
#         
#         print(f"🌙✨ Moon Dev Indicators Activated! BB Width: {bb_width[-1]:.4f} | KVO: {kvo_df.iloc[-1,0]:.2f}")
# 
#     def next(self):
...
#                 target_price = entry_price + 2 * atr_value
#                 
#                 self.buy(
#                     size=size,
#                     sl=stop_price,
#                     tp=target_price
#                 )
#                 print(f"🌙🚀✨ MOONSHOT ALERT! Long {size} units at {entry_price:.2f} | "
