"""
Moon Dev's VolatilityCompressionForce Strategy
...
#                 self.position.close()
#                 print(f"🌙🎯 MOON UPPER BAND TOUCH | Equity: {moon_equity:,.2f}")
#             elif current_close <= self.bb_lower[-1]:
#                 self.position.close()
#                 print(f"🌙🛑 MOON LOWER BAND TOUCH | Equity: {moon_equity:,.2f}")
#             
...
#             momentum_cond = (self.efi[-2] < 0 and self.efi[-1] > 0)  # Bullish crossover
#             
