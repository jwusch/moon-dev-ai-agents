"""
Moon Dev's VortexFlowReversal Strategy
...
#         
#         vm_plus = self.I(lambda h, l: abs(h - l), self.data.High, shifted_low)
#         vm_minus = self.I(lambda l, h: abs(l - h), self.data.Low, shifted_high)
#         
...
#             if (self.data.outflow[-1] > self.inflow_threshold * self.outflow_ma[-