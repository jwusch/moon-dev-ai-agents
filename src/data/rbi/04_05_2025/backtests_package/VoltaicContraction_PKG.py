...
#     
#     def init(self):
#         # Core indicators - all using talib now 🌙
#         self.ema20 = self.I(talib.EMA, self.data.Close, timeperiod=20)
#         self.atr20 = self.I(talib.ATR, self.data.High, self.data.Low, self.data.Close, timeperiod=20)
#         self.upper_bb, self.middle_bb, self.lower_bb = self.I(talib.BBANDS, self.data.Close, timeperiod=20, nbdevup=2, nbdevdn=2, matype=0)
...
#             return
#             
#         # Breakout check - using array indexing instead of crossover
