"""
Moon Dev's LiquidationRetrace Strategy
...
#                     tag="MOONSHOT ENTRY 🌙✨"
#                 )
#                 print(f"🚀 BLASTOFF! Long {position_size} @ {entry_price:.2f}")
...
#                     trade.close()
#                     print(f"🌕 PROFT CAPTURED AT MIDLINE! Closing @ {self.data.Close[-1]:.2f}")
