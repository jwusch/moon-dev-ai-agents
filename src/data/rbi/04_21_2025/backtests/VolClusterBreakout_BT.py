...
#         self.bb_upper, self.bb_middle, self.bb_lower = self.I(talib.BBANDS, close, 20, 2, 2, name='BBANDS')
...
#         
#         # MACD
#         self.macd, self.macd_signal, _ = self.I(talib.MACD, close, 12, 26, 9, name='MACD')
#         
#         # Swing levels
...
#                 print(f"🌙✨ MOON DEV SHORT SIGNAL! Selling {size} @ {price:.2f} | SL: {sl:.2f} 🌧