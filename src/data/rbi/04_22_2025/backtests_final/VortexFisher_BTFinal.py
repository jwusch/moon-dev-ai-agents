"""
Moon Dev's VortexFisher Strategy
...
#             if ((self.vi_plus[-2] < self.vi_minus[-2] and vi_plus > vi_minus) and \
#                (fisher > -2 and prev_fisher <= -2) and \
...
#         # Short entry logic        
#         if not self.position:
#             if ((self.vi_minus[-2] < self.vi_plus[-2] and vi_minus > vi_plus) and \
#                (fisher < 2 and prev_fisher >= 2) and \
#                (self.data.Volume[-1] > self.data.Volume[-2])):
#                 
...
#         # Exit logic
#         if self.position:
#             if (self.position.is_long and (self.vi_minus[-2] < self.vi_plus[-2] and vi_minus > vi_plus)) or \
#                (self.position.is_short and (self.vi_plus[-2] < self.vi_minus[-2] and vi_plus > vi_minus)) or \
#                (abs(f