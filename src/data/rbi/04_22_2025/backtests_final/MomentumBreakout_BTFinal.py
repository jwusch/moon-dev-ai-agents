        ...
        if not self.position:
            if (self.data.Close[-1] > self.donchian_upper[-1]) and (macd_current > macd_prev):
                ...
                if position_size > 0:
                    ...
                    print(f"🚀 Moon Boost! LONG {position_size} units @ {self.data.Close[-1]:.2f} | MACD Rising 🌛")
                ...
                if position_size > 0:
                    ...
                    print(f"🌒 Moon Dip! SHORT {position_size} units @ {self.data.Close[-1]:.2f} | MACD Falling 🌜")
