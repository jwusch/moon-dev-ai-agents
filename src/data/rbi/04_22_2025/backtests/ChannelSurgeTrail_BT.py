"""
Moon Dev's ChannelSurgeTrail Strategy
...
#         self.upper_band = self.I(talib.MAX, self.data.High, self.donchian_period)
#         self.lower_band = self.I(talib.MIN, self.data.Low, self.donchian_period)
#         
#     def next(self):
