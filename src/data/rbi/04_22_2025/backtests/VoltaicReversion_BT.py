"""
Moon Dev's VoltaicReversion Strategy
...
#         self.stddev = self.I(ta.STDDEV, self.data.Close, 20, name='STDDEV')
...
#             ta.BBANDS, self.data.Close, 20, 2, 2, 0, name=['BB_U','BB_M','BB_L']
#         )
#         self.bb_width = self.I(lambda u,l,m: (u-l)/m, self.bb_upper, self.bb_lower, self.bb_middle, name='BB_WIDTH')
#         self.vol_ma = self.I(ta.SMA, self.data.Volume, 20, name='VolMA')
# 
#     def next(self):
