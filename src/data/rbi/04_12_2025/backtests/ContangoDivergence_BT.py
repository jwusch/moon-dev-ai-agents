"""
Moon Dev's ContangoDivergence Strategy
...
# ```python
# # 🌙 Moon Dev's ContangoDivergence Backtest 🌙
# import pandas as pd
# import talib
...
#         self.putcall_ma = self.I(talib.SMA, self.data.df['put_call_ratio'], self.ma_period)
