"""
Moon Dev's VortexMomentumDivergence Strategy
...
# 
#         # Check exit signals - replaced crossover with array comparison
...
# 
#             # Long conditions
#             vi_cross = self.vi_p[i] > self.vi_m[i] and self.vi_p[i-1] <= self.vi_m[i