"""
Moon Dev's VortexChopTrend Strategy
...
# 
#         # Entry logic - replaced crossover with direct comparison
...
# 
#         # Exit logic - replaced crossover with direct comparison
#         else:
...
# bt = Backtest(data, VortexChopTrend