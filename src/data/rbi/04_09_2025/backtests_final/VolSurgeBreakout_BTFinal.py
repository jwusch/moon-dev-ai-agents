...
#                     print(f"🌙✨🚀 MOON DEV ENTRY: {position_size} shares @ {price:.2f} | SL {stop_price:.2f}")
...
#                 self.position.sl = max(new_sl, self.position.sl)  # Don't move SL backward
#                 print(f"🌙🔄 Trailing SL updated to {new_sl:.2f}")
#             
#             # Exit conditions
#             if self.bb_width[-1] < self.bb_threshold