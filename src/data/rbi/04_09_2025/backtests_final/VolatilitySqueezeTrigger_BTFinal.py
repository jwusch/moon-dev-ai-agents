...
#         macd_bull = (self.macd[-2] < self.signal[-2]) and (self.macd[-1] > self.signal[-1])
#         macd_bear = (self.signal[-2] < self.macd[-2]) and (self.signal[-1] > self.macd[-1])
# 
#         # Long entry
