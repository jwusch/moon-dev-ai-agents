...
#                     print(f"🌙 Moon Dev Exit SHORT: Closed at {self.data.Close[current_idx]:.2f}")
            ...
            above_kc = prev_close > self.data['KC_upper'][prev_idx]
            volume_ok = prev_volume > 1.2 * volume_sma
            
            if above_bb and above_kc and volume_ok:
                entry_price = self.data.Open[current_idx]