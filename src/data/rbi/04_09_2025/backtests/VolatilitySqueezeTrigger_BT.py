...
#         macd_bull = crossover(self.macd, self.signal)
#         macd_bear = crossover(self.signal, self.macd)
# 
#         # Long entry
...
#             
#             if size > 0:
#                 self.buy(size=size, tag="🌕 BULLISH SQUEEZE BREAKOUT")
#                 self.trades_today += 1
#                 print(f"🚀 LONG | Size: {size} | Entry: {self.data.Close[-1]} | SL: {sl_price}")
# 
#         # Short entry
#         elif not self.position and bb_squeeze and volume_spike and