"""
Moon Dev's VoltaSqueezeBreakout Strategy
...
# Here's the complete backtesting implementation for the VoltaSqueezeBreakout strategy:
# 
# ```python
...
#             short_cond = (
#                 self.bb_bandwidth[-1] < self.bb_percentile[-1