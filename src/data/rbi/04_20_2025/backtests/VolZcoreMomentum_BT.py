"""
Moon Dev's VolZcoreMomentum Strategy
...
#         stop_loss = 2 * atr
#         position_size = int(round(min(risk_amount / (stop_loss * price), max_size)))
# 
...
#                     self.position.close()
#                     print(f"🌓 GRAVITY RELEASE: Closing short @ {price:.2f}")
# 
# bt = Backtest(data, VolZcore