...
#                     print(f"🌙🚀 MOON DEV LONG! Size: {position_size} @ {current_close:.2f} SL: {sl_price:.2f}")
# 
#             # Short logic
...
#                     print(f"🌙🌒 MOON DEV SHORT! Size: {position_size} @ {current_close:.2f} SL: {sl_price:.2f}")
# 
#         elif current_atr < exit_threshold:
#             self.position.close()
#             print(f"🌙💤 VOL EXIT! Closed @ {current_close:.2f} ATR: {current_atr:.2f}")
# 
