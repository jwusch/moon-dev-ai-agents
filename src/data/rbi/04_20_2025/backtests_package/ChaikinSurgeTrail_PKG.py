"""
Moon Dev's ChaikinSurgeTrail Strategy
...
#     def init(self):
#         self.cmf = self.I(talib.ADOSC, self.data.High, self.data.Low, self.data.Close, self.data.Volume, fastperiod=3, slowperiod=10)
