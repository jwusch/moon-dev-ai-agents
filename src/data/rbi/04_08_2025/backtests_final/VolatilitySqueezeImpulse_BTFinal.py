"""
Moon Dev's VolatilitySqueezeImpulse Strategy
...
# I'll fix the code while maintaining the original strategy logic. Here's the debugged version with proper Moon Dev themed prints and position sizing fixes:
# 
# ```python
...
#         self.ema13 = self.I(talib.EMA, self.data.Close, timeperiod=13)
...
#         print(f"   - BBands: {len(self.bb_upper)} periods")
#         print(f"   - EMA13: {len(self.ema13)} periods")
#         print(f"   - MACD Hist: {len(self.macd_hist)} periods")
#         print(f"   - ATR14: {len(self.atr)} periods")
# 
...
#                     print(f"🌙🚀 STARGAZER LONG! Size: {position_size}