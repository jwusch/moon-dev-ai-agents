...
#                     print(f"🌙✨ MOON DEV LONG ENTRY! Size: {position_size} @ {current_close:.2f} 🚀")
...
#                     print(f"🌙✨ MOON DEV SHORT ENTRY! Size: {position_size} @ {current_close:.2f} 🌑")
        ...
        # Trade management logic ✨
            ...
            if self.position.is_long:
                ...
                if current_close < self.ema[-1]:
                    self.position.close()
#                     print(f"🌙🛑 MOON DEV LONG EXIT (EMA Cross) @ {current_close:.2f}")
                elif current_close < trail_stop:
                    self.position.close()
#                     print(f"🌙🛑 MOON DEV LONG EXIT (Trailing SL) @ {current_close:.2f}")
