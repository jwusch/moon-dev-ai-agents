...
#         #print(f"Bar {i} | Close: {current_close} | Bandwidth: {self.bandwidth[i]:.2f} | Min BW: {self.min_bandwidth[i]:.2f}")
# 
#         # Entry Logic
...
#                             print(f"🌙🚀 LONG SURGE! Entry: {current_close:.2f} | Size: {position_size} | SL: {stop_price:.2f} | Equity: {self.equity:.2f}")
# 
#                 # Short Entry        
...
#                             print(f"🌙🌌 SHORT SQUEEZE! Entry: {current_close:.2f} | Size: {position_size} | SL: {stop_price:.2f} | Equity: {self.equity:.2f}")
# 
#         # Exit Logic
#         else:
...
#                 self.position.close()
#                 print(f"🌙💎 LONG EXIT! RSI Reversal at {current_rsi:.2f} | Price: {current_close:.2f}")
# 
#             if self.position.is_short and prev_rsi <=