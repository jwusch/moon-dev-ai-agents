...
#     def init(self):
#         # Core indicators 🌙
#         self.atr_15m = self.I(talib.ATR, self.data.High, self.data.Low, self.data.Close, 14, name='ATR_15m')
#         
...
#                 self.position.close()
#                 print(f"🌑💫 MOON OUT! Exit @ {self.data.Close[-1]:.2f} | Trail SL: {self.trailing_stop:.2f} 💫🌑")
# 
# # Run backtest 🌙🚀
# bt = Backtest(data, VolatilitySurge, cash=1_000