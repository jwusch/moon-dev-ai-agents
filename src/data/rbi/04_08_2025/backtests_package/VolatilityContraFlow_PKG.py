"""
Moon Dev's VolatilityContraFlow Strategy
...
#                         
#                         print(f"🌙 Moon Dev Long Signal! | Size: {position_size:.4f} | Entry: {self.data.Close[-1]:.2f} | SL: {stop_loss:.2f} | TP: {take_profit:.2f}")