"""
Moon Dev's VolAdaptiveCrossover Strategy
...
#             # Bullish crossover check (replaces backtesting.lib.crossover)
#             if (self.ema50[-2] < self.ema200[-2] and self.ema50[-1] > self.ema200[-1]) and hv20 < hv20_p20:
...
#         # Exit logic 🌑
#         else:
#             # Bearish crossover check (replaces backtesting.lib.crossover)
#             if hv20 > hv20_p50 or (self.ema50[-2] > self.ema200[-2] and self.ema50[-1] < self.ema200[-1]):
#                 self.position.close()
...
# 
# # Launch backtest 🚀
# bt = Backtest(data, VolAdaptiveCrossover, cash=1_000_000,