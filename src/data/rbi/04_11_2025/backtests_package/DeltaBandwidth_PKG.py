"""
Moon Dev's DeltaBandwidth Strategy
...
#             print("🌙 MOON DEV: Waiting for enough data... ✨")
#             return
# 
#         # Check bandwidth contraction
#         if self.bandwidth[-1] != self.bandwidth_low[-1]:
#             print("🌙 MOON DEV: Bandwidth not at minimum - waiting... ✨")
#             return
# 
...
#                     print(f"🚀 MOON DEV LONG SIGNAL! 🌙 Size: {position_size} | Entry: {current_close:.2f} | SL: {stop_price:.2f} ✨")
#                     print(f"🌕 Bandwidth: {self.bandwidth[-1]:.4f} | CVD: {self.cvd[-1]:.0f} | ATR: {atr_value:.2f}")
# 
#             # Short entry
...
#                     print(f"🌑 MOON DEV SHORT SIGNAL! 🌙 Size: {position_size} | Entry: {current_close:.2f} | SL: {stop_price:.2f} ✨")
#                     print(f"🌓 Bandwidth: {self.bandwidth[-1]:.4