"""
Moon Dev's LiquidityFade Strategy
...
#         self.volume_max = self.I(talib.MAX, self.data.Volume, 20, name='Volume Max')
#         
...
#         self.sum_product = self.I(talib.SUM, product, 15, name='Sum TPV')
#         self.sum_volume = self.I(talib.SUM, self.data.Volume, 15, name='Sum Vol')
#     
#     def next(self):
...
#                 print(f"🌙✨ LONG ENTRY! Price: {price:.2f}, Size: {position_size}")
#                 print(f"    SL: {stop_loss:.2f}, TP: {current_vwap:.2f} 🚀")
#         
...
# 
# # Run backtest 🌙📊
# bt = Backtest(data, LiquidityFade, cash