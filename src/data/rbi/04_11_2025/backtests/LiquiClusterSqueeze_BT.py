"""
Moon Dev's LiquiClusterSqueeze Strategy
...
#         self.bb_stddev = self.I(talib.STDDEV, self.data.Close, 20, 1)
#         
#         # Volume indicators
#         self.volume_ma = self.I(talib.SMA, self.data.Volume, 20)
#         
#         # Liquidation clusters (swing levels)
#         self.swing_high = self.I(talib.MAX, self.data.High, 50)
#         self.swing_low = self.I(talib.MIN, self.data.Low, 50)
#         
