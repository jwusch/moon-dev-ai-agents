...
class ClusterBandwidth(Strategy):
    def init(self):
        ...
        self.mid = self.I(talib.SMA, self.data.Close, 20)
        ...
        self.cluster_high = self.I(talib.MAX, self.data.High, 20)
        self.cluster_low = self.I(talib.MIN, self.data.Low, 20)
