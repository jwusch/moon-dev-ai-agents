...
#         self.atr50_sma = self.I(talib.SMA, self.atr10, self.atr_period_50)
#         self.atr20_sma = self.I(talib.SMA, self.atr10, self.atr_period_20)
#         self.consolidation_high = self.I(talib.MAX, self.data.High, self.consolidation_period)
#         self.consolidation_low = self.I(talib.MIN, self.data.Low, self.consolidation_period)
#         
