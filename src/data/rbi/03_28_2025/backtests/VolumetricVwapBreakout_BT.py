"""
Moon Dev's VolumetricVwapBreakout Strategy
...
#                     print(f"🌙🚀 LONG! Size: {size} | Entry: {current_open:.2f} | SL: {sl:.2f} ✨")
# 
#             # Short Entry
...
#                              sl=sl,
#                              tp=current_open - 2*current_atr)
#                     print(f"🌙📉 SHORT! Size: {size} | Entry: {current_open:.2f} | SL: {sl:.2f} ✨")
#         else:
#             # Exit if price re-enters VWAP envelope 🌙💎
#             current_close = self.data.Close[-1]
#             current_vwap = self.vwap[-1]
#             current_std = self.std_dev[-1]
#             current_upper = current_vwap + 2 * current_std
#             current_lower = current_vwap - 2 * current_std
#             
#             if self.position.is