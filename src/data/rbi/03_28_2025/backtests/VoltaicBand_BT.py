"""
Moon Dev's VoltaicBand Strategy
...
#             # Long entry
#             if crossover(current_close, upper_band_prev):
...
#             
#             # Short entry
#             elif crossover(lower_band_prev, current_close):
#                 risk_amount = self.equity * self.risk_percent
#                 entry_price = current_close
#                 stop_loss = self.vwap[-1]  # Current bar's VWAP
...
#                 exit_price = self.tracking_high - 0.5*(self.tracking_high - self.entry_vwap)
#                 
