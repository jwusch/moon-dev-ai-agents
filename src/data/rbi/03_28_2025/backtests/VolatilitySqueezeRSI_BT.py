"""
Moon Dev's VolatilitySqueezeRSI Strategy
...
# Here's the complete implementation of the VolatilitySqueezeRSI strategy for Moon Dev:
# 
# ```python
...
#         self.rsi3 = self.I(talib.RSI, self.data.Close, 3)
#         
#         # Price changes for volatility calculation
#         price_changes = self.I(talib.MOM, self.data.Close, 1)
#         
#         # 50-period volatility (standard deviation)
#         self.volatility = self.I(talib.STDDEV, price_changes, 50)
#         
...
# # LAUNCH BACKTEST 🚀🌙
# # ========================
# bt = Backtest(data, VolatilitySqueezeRSI, 
#              cash=1_000_000,
#              commission=.002,
#              exclusive_