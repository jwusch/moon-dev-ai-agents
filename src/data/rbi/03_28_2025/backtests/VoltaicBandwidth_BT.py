"""
Moon Dev's VoltaicBandwidth Strategy
...
#         self.kc_sma = self.I(talib.SMA, self.kc_width, 10, name='KC_SMA')
#         
#         # Volume MA
...
#                 print(f"🚀🌙 LIFT OFF! Long {size} @ {price:.2f} | Stop: {sl:.2f}")
#         
#         # Short entry
...
#                 print(f"🌑🌙 SHORT CIRCUIT! Short {size} @ {price:.2f} | Stop: {sl:.2