...
# I'll fix the code by removing the `backtesting.lib` import and replacing any related functionality. Here's the corrected version with Moon Dev themed debug prints:
# 
# ```python
...
#                     highest_high = max(self.data.High[trade.entry_bar:trade.entry_bar+len