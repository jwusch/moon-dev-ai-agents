"""
Moon Dev's VolumeSilhouetteEMA Strategy
...
#                 print(f"🌙💰 Position P&L: {self.position.pl:,.2f}")
# 
# # 🌙 DATA PREPARATION 🌙
...
# print("🌕 Final Equity:", f"${stats['Equity Final [$]']:,.2f}")
# print("🌑 Max Drawdown:", f"{stats['Max. Drawdown