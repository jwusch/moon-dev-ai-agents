...
#         self.bb_width_min = self.I(talib.MAX, self.bb_width, timeperiod=self.contraction_period)
#         self.bb_width_max = self.I(talib.MIN, self.bb_width, timeperiod=self.contraction_period)
#         
