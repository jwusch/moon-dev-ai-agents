"""
Moon Dev's VolcanicSqueeze Strategy
...
# Here's the fully debugged and Moon Dev optimized version of your VolcanicSqueeze strategy:
# 
# ```python
# import pandas as pd
# import talib
...
#         squeeze = (upper - lower) < (self.upper_band[-2] - self.lower_band[-2])
# 
#         # Moon Dev themed debug prints
#         print(f"🌙 Current Close: {current_close:.2f} | Upper: {upper:.2f} | Lower: {lower:.2f}")
#         print(f"📈 Volume: {current_volume:.0f} vs MA20: {vol_ma:.0f} | Surge: {'✅' if volume_surge else '❌'}")
