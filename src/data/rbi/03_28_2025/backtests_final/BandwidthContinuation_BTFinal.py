"""
Moon Dev's BandwidthContinuation Strategy
...
#         self.bandwidth_sma = self.I(talib.SMA, self.bandwidth, timeperiod=20)
#         self.bandwidth_std = self.I(talib.STDDEV, self.bandwidth, timeperiod=20)
#         
...
#                 if risk > 0:
#                     size = int(round((self.equity * 0.01) / risk))  # Fixed: whole number units
