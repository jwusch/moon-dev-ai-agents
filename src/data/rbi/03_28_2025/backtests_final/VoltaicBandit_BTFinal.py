"""
Moon Dev's VoltaicBandit Strategy
...
# Here's the fully debugged and fixed version of your VoltaicBandit strategy with proper Moon Dev formatting and all technical issues resolved:
# 
# ```python
...
#                     print(f"🚀🌙 LONG ENTRY | Size: {position_size} | Entry: {price:.2f} | SL: {stop_loss:.2f} | TP: {price + 4*atr_value:.2f}")
#             
...
#                              sl=stop_loss,
#                              tp=price - 4*atr_value)
#                     print(f"🌑🌙 SHORT ENTRY | Size: {position_size} | Entry: {price:.2f} | SL: {stop_loss:.2f} | TP: {price - 4*atr_value:.2f}")
# 
#         # 🌙 Exit Logic
