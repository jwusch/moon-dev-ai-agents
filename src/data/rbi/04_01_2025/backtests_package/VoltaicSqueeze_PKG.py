...
#             
#             if risk_per_share <= 0:
#                 print("🌙✨ MOON DEV ALERT: Risk per share <=0, skipping entry")
#                 return
#             
...
#                 print(f"🚀🌕 MOON DEV ENTRY: Long {position_size} @ {entry_price:.2f} | Lunar Cycle Activated")
#     
...
#                 self.position.close()
#                 print(f"🌑🛑 MOON DEV TRAILING STOP: {self.data.Close[-1]:.2f} | Moon Phase Complete")
#             
#             # Emergency volatility exit
#             elif self.bb_percentile[-1] >