"""
Moon Dev's VolatilitySurgeBreakout Strategy
...
#         self.std_dev = self.I(talib.STDDEV, self.typical_price, self.vwap_period, name='STDDEV')
#         
#         # 🌙 Create VWAP Bands
...
#         self.volume_median = self.I(talib.MEDIAN, self.data.Volume, self.volume_median_period, name='VOL_MEDIAN')
#         
...
#                     print(f"🌙🚀 LONG ENTRY at {price:.2f} | Size: {position_size} | SL: {sl_price:.2f} ✨")
#         
#         # 🌑 Short Entry Logic
...
#                 position_size = int(round(risk_amount / risk_per_share))
#                 if position_size > 0:
#                     self.sell(size=position_size, sl=sl_price, tag="Moon Surge Short")
#                     print(f"🌙🌑 SHORT ENTRY at {price:.2f} | Size: {position_size} | SL: {