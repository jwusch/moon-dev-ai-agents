"""
Moon Dev's VolumetricBreakout Strategy
...
#         self.ema50 = self.I(ta.EMA, close, 50, name='EMA50')
#         self.ema200 = self.I(ta.EMA, close, 200, name='EMA200')
#         self.volume_sma20 = self.I(ta.SMA, self.data.Volume, 20, name='Volume SMA20')
#         self.atr14 = self.I(ta.ATR, self.data.High, self.data.Low, close, 14, name='ATR14')
# 
#     def next(self):
...
#             # EMA Crossover Constellation
#             golden_cross = ema50 > ema200 and prev_ema50 <= prev_ema200
#             # Volume Supernova
...
# 
#             # Death Cross Abort Sequence ☠️
#             death_cross = ema50 < ema200 and prev_ema50 >= prev_ema200
#             if death_cross:
#                 self.sell()
#                 print(f"🌘 DEATH CROSS DETECTED! Exiting at {self.data.Close[-1]:.2f}")
# 
# # Launch Moon Mission 🚀
# data = prepare_data("/Users/md/Dropbox/dev/github/moon-dev-ai-agents-for-trading/src/data/rbi/BTC-USD