"""
Moon Dev's VoltaicSqueeze Strategy
...
#                 
#                 print(f"🚀 LONG SIGNAL! Size: {position_size} | Entry: {current_close:.2f}")
...
#                 position_size = int(round(position_size))
#                 
#                 print(f"📉 SHORT SIGNAL! Size: {position_size} | Entry: {current_close:.2f}")
...
#                 new_stop = current_close - (self.trailing_atr_mult * self.atr[-1])
#                 self.trailing_stop = max(self.trailing_stop, new_stop)
#                 # Close if price closes below trailing stop or back inside BB
#                 if current_close < self.trailing_stop or current_close < self.upper[-1]:
#                     print(f"🟢 LONG EXIT: Trailing