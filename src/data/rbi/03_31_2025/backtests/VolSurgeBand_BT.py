"""
Moon Dev's VolSurgeBand Strategy
...
#         
#         # BBW Percentile Rank
#         self.bbw_percentile = self.I(pandas_ta.percentrank, self.bbw, self.bbw_percentile_length, name='BBW_PCT')
#         
#         # Volume indicators
#         self.volume_sma20 = self.I(talib.SMA, self.data.Volume, self.volume_sma_length, name='VOL_SMA20')
#         
#     def next(self):
...
#             vol_ratio = current_volume / self.volume_sma20[-1] if self.volume_sma20[-1] != 0 else 0
#             
#             # Long entry logic
#             if (self.bbw_percentile