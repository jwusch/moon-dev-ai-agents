"""
Moon Dev's ForceBandContraction Strategy
...
#         self.efi_sma3 = self.I(talib.SMA, self.efi, 288)  # 3-day SMA for 15m data
#         
#         # Bollinger Bands
...
#         self.band_width_avg = self.I(talib.SMA, self.band_width, 20)
#         
#         # Volatility measures
...
#         efi_cross = crossover(self.efi, self.efi_sma3)
...
#                     self.position.close()
#                     print(f"🌙🛑 STOP LOSS! Long @ {self.position.entry_price:.2f} | Current: {price:.2f}")
#                 # Target hit
#                 elif self.data.Low[-1] <= self