...
#         else:
#             mid_cross = crossover(self.keltner_mid, self.data.Close)
#             volatility_ok = self.bb_width_ma[-1] > self.bb_width_ma[-1]
#             
#             if mid_cross and volatility_ok:
#                 self.position.close()
#                 print(f"🌖 MOON DEV EXIT: Closing at {self.data.Close[-1]}! Returning to orbit 🛸")
# 
# # 🌟 Launch Backtest Sequence
# data = prepare_data('/Users/md/Dropbox/dev/github/moon-dev-ai-agents-for-trading/src/data