"""
Moon Dev's VortexBreakout Strategy
...
#         self.adx = self.I(talib.ADX, high, low, close, 14, name='ADX')
#         
...
#         if crossover(self.vi_plus, self.vi_minus) and price > self.kc_upper[-1]:
...
#         elif crossover(self.vi_minus, self.vi_plus) and price < self.kc_lower[-1]:
...
# 
# # 🚀 Launch Backtest
# bt = Backtest(data, VortexBreakout, cash=1_000_000, commission=.002)
# stats = bt.run()
# print("\n🌙✨===