"""
Moon Dev's VolClusterReversal Strategy
...
# Here's the implementation of the VolClusterReversal strategy for backtesting.py:
# 
# ```python
...
#             risk_amount = equity * self.risk_pct
#             position_size = int(round(risk_amount / (sl