...
#         self.upper = self.I(lambda: upper, name='Upper BB')
#         self.lower = self.I(lambda: lower, name='Lower BB')
#         self.bbw = self.I(lambda: (upper-lower)/mid, name='BB Width')
...
#                     
#                     print(f"🚀🌙 LONG Signal | Size: {size} units | Entry: ${self.data.Close