...
#         self.atr90_avg = self.I(talib.SMA, self.atr20, timeperiod=90)
#         self.volume_ma30 = self.I(talib.SMA, self.data.Volume, timeperiod=30)
...
#         position_size = int(round(position_size))  # 🌕 CRUCIAL: Round to whole units 🌕
#         
#         if position_size <= 0:
