"""
Moon Dev's VolumetricTrix Strategy
...
#                 self.position.close()
#                 pl_pct = (self.position.pl / self.position.size) / self.position.entry_price * 100
#                 print(f"🌘🛰 EXIT SIGNAL: Trailing Stop {trailing_stop:.2f} | Max High