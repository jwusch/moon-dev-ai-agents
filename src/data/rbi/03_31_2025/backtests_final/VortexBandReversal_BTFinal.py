"""
Moon Dev's VortexBandStrategy Strategy
...
#             vi_bearish_cross = crossover(self.vi_minus, self.vi_plus)
#             
...
#                     print(f"🛑 Cosmic Stop Loss set at {stop_loss:.2f} | ATR: {atr_value:.2f}")
#         
#         # 🌕 Exit Conditions
#         elif self.position.is_short:
#             if crossover(self.data.Close,