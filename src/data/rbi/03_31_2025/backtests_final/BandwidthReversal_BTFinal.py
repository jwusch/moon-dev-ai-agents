...
# Here's the fully debugged and Moon Dev themed backtest code for the BandwidthReversal strategy:
# 
# ```python
...
#             macd_cross = (self.macd_hist[-2] < 0 and self.macd_hist[-1] > 0)
#             
...
# 
# # 🚀 Run Backtest
# bt = Backtest(data, BandwidthReversal, commission=.002, exclusive_orders=True)
# results = bt.run()
# 
# print("\n🌕🌖🌗🌘🌑