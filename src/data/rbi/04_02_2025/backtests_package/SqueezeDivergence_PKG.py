"""
Moon Dev's SqueezeDivergence Strategy
...
#         if (is_squeeze and
#             price > bb_upper and
#             (self.vwap[-2] < self.vwap_ma[-2] and self.vwap[-1] > self.vwap_ma[-1]) and  # Replaced crossover
#             volume_ok):
#             
...
#         elif (is_squeeze and
#               price < bb_lower and
#               (self.vwap[-2] > self.vwap_ma[-2] and self.vwap[-1] < self.vwap_ma