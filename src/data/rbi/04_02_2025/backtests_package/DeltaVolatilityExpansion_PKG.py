"""
Moon Dev's DeltaVolatilityExpansion Strategy
...
#         self.ema20 = self.I(talib.EMA, self.data.Close, timeperiod=self.atr_period, name='EMA20')
#         self.atr20 = self.I(talib.ATR, self.data.High, self.data.Low, self.data.Close, timeperiod=self.atr_period, name='ATR20')
#         self.volume_sma20 = self.I(talib.SMA, self.data.Volume, timeperiod=self.atr_period, name='VolumeSMA20')
#         
...
#             print(f"🌙 MOON DEV LONG ENTRY 🚀 | Price: {entry_price:.2f} | Size: {position_size} | SL: {stop_loss:.2f} | TP: {take_profit:.