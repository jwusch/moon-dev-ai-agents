...
#         self.width_low = self.I(talib.MIN, self.channel_width, timeperiod=20)
#         
#         # Volume Analysis 📉
#         self.vol_sma5 = self.I(talib.SMA, self.data.Volume, timeperiod=5)
#         self.vol_sma20 = self.I(talib.SMA, self.data.Volume, timeperiod=20)
#         
...
#                 self.position.close()
#                 print(f"🌙✨ SHORT LANDING EXIT: {price:.2f} | Profit: {self.position.pl