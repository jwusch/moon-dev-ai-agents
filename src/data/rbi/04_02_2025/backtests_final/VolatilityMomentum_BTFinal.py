...
# Here's the fully debugged and Moon Dev themed backtest code:
# 
# ```python
...
#             # CMO crosses above dynamic threshold (replaced crossover)
#             cmo_cross = (self.cmo[-2] < self.threshold[-2] and self.cmo[-1] > self.threshold[-1])
#             
...
#                 if risk_per_share <= 0:
#                     print("🌑 WARNING: Invalid stop price - skipping trade")
#                     return
#                 
