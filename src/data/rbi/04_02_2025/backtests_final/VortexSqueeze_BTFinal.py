...
#             if ((vi_plus > vi_minus and self.data.VI_PLUS[-2] <= self.data.VI_MINUS[-2]) and \
...
#             elif ((vi_minus > vi_plus and self.data.VI_MINUS[-2] <= self.data.VI_PLUS[-2]) and \
#                   (bb_width < bb_width_avg) and \
#                   (close < lower_bb)):
#                   
#                 risk_amount = self.equity * self.risk_percent
