"""
Moon Dev's VwapSqueezeBreakout Strategy
...
#                     print(f"🌙✨ MOON DEV LAUNCH! Long {position_size} units @ {current_close:.2f}")
...
#                 self.position.close()
#                 if bbw_expansion:
#                     print(f"🌙💸 MOON DEV LANDING! BBW Expansion {current_bbw:.4f} > 2*StdDev")