"""
Moon Dev's VortexSurge Strategy
...
#         self.vi_plus = self.I(lambda x: x, vortex['VORTl_14'], name='VI+')
#         self.vi_minus = self.I(lambda x: x, vortex['VORTs_14'], name='VI-')
# 
#         # Volume Surge 📈
...
#             if vi_minus_cross or bars_held >= self.max_bars_held:
#                 self.position.close()
#                 print(f"\n🌙⏹️ EXIT SIGNAL @ {price