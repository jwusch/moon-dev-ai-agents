"""
Moon Dev's VolSurgeBreakout Strategy
...
# Here's the fixed and completed backtest code with all Moon Dev improvements and proper position sizing:
# 
# ```python
...
#         self.donchian_upper = self.I(talib.MAX, self.data.High, timeperiod=20, name='DONCHIAN_UPPER')
#         self.donchian_lower = self.I(talib.MIN, self.data.Low, timeperiod=20, name='DONCHIAN_LOWER')
#         
#         # Volume indicators (3-day surge vs 30-day median)
#         self.volume_3d = self.I(talib.SUM, self.data.Volume, timeperiod=288, name='VOL_3D')  # 3 days in 15m intervals
#         self.volume_30d_median = self.I(pdta.median, self.data.Volume, length=2880, name='VOL_30D_MED')  # 30 days
#         
