"""
Moon Dev's VoltaicDivergence Strategy
...
#                     print(f"🌙🚀 BEARISH DIVERGENCE DETECTED! Short {position_size} units @ {self.data.Close[-1]:.2f} | SL: {self.data.Close[-1] + atr_value:.2f} | TP: {self.data.Close[-1] - (2 * atr_value):.2f}")
# 
#         # 🌒 Exit Logic
