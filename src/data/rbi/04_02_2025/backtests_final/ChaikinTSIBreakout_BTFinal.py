"""
Moon Dev's ChaikinTSIBreakout Strategy
...
#         tsi_cross = (self.tsi_line[-2] < self.tsi_signal[-2] and self.tsi_line[-1] > self.tsi_signal[-1])
...
#                     print(f"🌙🚀 BULLISH BREAKOUT! Long {size} units @ {entry:.2f} with stop @ {stop_loss:.2f} ✨")
# 
#         # SHORT ENTRY CONDITIONS 🌙
#         cmf_bearish = self.cmf[-1] <