...
# Here's the complete fixed backtest code with Moon Dev themed debug prints, ensuring proper position sizing and technical corrections while preserving the original strategy logic:
# 
# ```python
# import numpy as np
# import pandas as pd
