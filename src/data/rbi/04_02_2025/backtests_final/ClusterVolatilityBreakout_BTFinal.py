"""
Moon Dev's ClusterVolatilityBreakout Strategy
...
# Here's the fixed and completed version of the ClusterVolatilityBreakout strategy with proper position sizing and all technical issues resolved:
# 
# ```python
...
#         'close': 'Close',
#         'volume': 'Volume',
#         'liquidation_high': 'Liquidation_High',
#         'liquidation_low': 'Liquidation_Low'
#     }
...
#     risk_per_trade = 0.01  # 1% risk per trade (fraction of equity)
...
#         cluster_high = self.data.Liquidation_High[-1]
#         cluster_low = self.data.Liquidation_Low[-1]
#         
