...
# Here's the debugged and completed version of your VolClusterBreakout strategy with Moon Dev themed improvements:
# 
# ```python
# import pandas as pd
# import talib
...
#         return round(position_size, 8)  # Round to 8 decimal places for crypto precision
# 
#     def next(self):
...
#             if position_size > 0:
#                 print(f"🚀🌕 MOON BLASTOFF LONG: {position_size:.8f} units at {