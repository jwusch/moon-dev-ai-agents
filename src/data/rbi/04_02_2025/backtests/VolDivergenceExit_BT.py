...
#         self.price_high = self.I(talib.MAX, self.data.High, 5, name='PriceHigh5')
#         self.obv_high = self.I(talib.MAX, self.obv, 5, name='OBVHigh5')
#         
...
#                 return
#                 
#             # Emergency Exit: Black hole escape 🕳️
#             if price < lower