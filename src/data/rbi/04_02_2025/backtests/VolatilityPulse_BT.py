...
#         self.atr_ma = self.I(talib.SMA, self.atr, 20, name='ATR_MA_20')
#         self.vix_sma = self.I(talib.SMA, self.data['vix'], 10, name='VIX_SMA_10')
#         
...
#         
#         print(f"✨ ATR CROSS: {atr_cross[-1]} | VIX FILTER: {vix_filter}")
