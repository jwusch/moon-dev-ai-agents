"""
Moon Dev's LiquidationSqueeze Strategy
...
#         
#         self.bb_lower = self.I(lambda close: talib.BBANDS(close, 20)[2], self.data.Close, name='✨ BB LOWER')
...
#         self.volume_ma = self.I(talib.SMA, self.data.Volume, 20, name='✨ VOLUME MA 20')
#         
...
#                                 tp=tp_level,
#                                 tag="🌙 MOON SHOT LONG 🚀")
#                         print(f"🌙 LIFTOFF! LONG {position_size} @ {price}")
#                         print(f"   🛡️ SL: {midpoint} | 🎯 TP: {tp_level}")
#             
#             # ✨ SHORT ENTRY LOGIC
...
#                                  sl=midpoint,
#                                  tp=tp_level,
#                                  tag="✨ COMET RIDER SHORT ☄️")
#                         print(f"✨ REENTRY! SHORT {position_size} @ {price}")
#                         print(f"   🛡️ SL: {midpoint} | 🎯 TP: {tp_level}")
# 
# # 🌙 DATA PREPARATION
# data =