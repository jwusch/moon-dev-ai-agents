"""
Moon Dev's BandwidthImpulse Strategy
...
#         adx_cross_above = current_adx > 25 and previous_adx <= 25
#         
...
#                     self.position.close()
#                     print(f"🎯 Moon Dev Profit Reached! +{1 - self.take_profit/self.position.entry_price:.2%}")
