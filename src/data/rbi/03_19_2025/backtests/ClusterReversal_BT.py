"""
Moon Dev's ClusterReversal Strategy
...
#         self.atr_sma = self.I(talib.SMA, self.atr, 14)
#         
#         # Swing levels
...
#             if ha_bearish and prev_ha_bearish == False and volatility_ok:
...
#             elif ha_bullish and prev_ha_bullish == False and volatility_ok:
...
#                     
#                     if position_size > 0:
#                         self.buy(size=position_size, sl=stop