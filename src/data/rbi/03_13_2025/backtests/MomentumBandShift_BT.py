"""
Moon Dev's MomentumBandShift Strategy
...
#         self.rsi5 = self.I(talib.RSI, self.data.Close, 5)
#         self.min_rsi_3 = self.I(talib.MIN, self.rsi5, 3)
#         self.ma10 = self.I(talib.SMA, self.data.Close, 10)
#         
#         # 🎢 Bollinger Bands Calculation
#         def bb_upper(close): return talib.BBANDS(close, 20, 2, 2)[0]
#         def bb_middle(close): return talib.BBANDS(close, 20, 2, 2)[1]
...
#                     self.position.close()
#                     print(f"🌙💫 CLOSE SHORT | Price: {price:.2f} | MA10: {ma10:.2f} 🌌")
# 
# # 🚀 Launch Backtest
# bt = Backtest(data