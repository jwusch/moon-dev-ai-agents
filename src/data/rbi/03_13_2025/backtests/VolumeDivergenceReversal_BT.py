...
class VolumeDivergenceReversal(Strategy):
    ...
    def init(self):
        ...
        self.sma50 = self.I(talib.SMA, self.data.Close, self.sma_short, name='SMA50')
        self.sma200 = self.I(talib.SMA, self.data.Close, self.sma_long, name='SMA200')
        ...
        self.sum_up_vol = self.I(talib.SMA, upside_vol, self.rsi_period, name='SumUpVol')
        self.sum_down_vol = self.I(talib.SMA, downside_vol, self.rsi_period, name='SumDownVol')
...
# Data Preparation
data_path = '/Users/md/Dropbox/dev/github/moon-dev-ai-agents-for-trading/src/data/r'