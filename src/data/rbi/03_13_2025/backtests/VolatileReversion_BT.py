...
class VolatileReversion(Strategy):
    ...
    def next(self):
        ...
        if self.position:
            ...
            rsi_exit_long = crossover(self.rsi, 40)
            rsi_exit_short = crossover(60, self.rsi)
        ...
        # 🌙 ENTRY CONDITIONS
            ...
            bull_div = (self.price_swing_low[-1] < self.price_swing_low[-2] and 
                       self.macd_swing_low[-1] > self.macd_swing_low[-2])
            bear