"""
Moon Dev's HarmonicConvergence Strategy
...
#                         print(f"🌙🚀 BULLISH CONVERGENCE! LONG {position_size} @ {current_close:0.2f}")
#                         print(f"   🛡️ SL: {sl_price:0.2f}, 🎯 TP: {tp_price:0.2f}")
# 
...
#                         print(f"🌙🌒 BEARISH DIVERGENCE! SHORT {position_size} @ {current_close:0.2f}")
#                         print(f"   🛡️ SL: {sl_price:0.2f}, 🎯 TP: {tp_price:0.2f}")
# 
#         else:
#             # Exit conditions
...
#                     self.position.close()
#                     print(f"🌙✨ CLOSING LONG @ {current_close:0.2f} - {'HO Reversal' if current_ho < 0 else 'MA Bearish Flip'}")
# 
