...
#                     print(f"🌙✨ BUY SIGNAL ✨\nEntry: {price:0.2f} | Size: {size} | SL: {sl:0.2f} | RSI: {rsi:0.1f} 🌟")
#             
...
#                     print(f"🌙✨ SELL SIGNAL ✨\nEntry: {price:0.2f} | Size: {size} | SL: {sl:0.2f} | MA10: {ma10:0.2f} 🌟")
#         
#         # 💫 Exit Conditions
#         else:
...
#                     self.position.close()
#                     print(f"🌙💫 CLOSE LONG | Price: {price:0.2f} | RSI: {rsi:0.1f} 🌌")
#                     
