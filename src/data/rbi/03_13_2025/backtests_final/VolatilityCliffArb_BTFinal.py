"""
Moon Dev's VolatilityCliffArb Strategy
...
#             print(f"🌙 MOON DEV STATUS: Bar {len(self.data)} | Equity: {self.equity:,0.0f} ✨")
# 
#         if self.position:
...
#                     print(f"🌙 MOON DEV SHORT ENTRY 🚀\nEntry: {entry_price:0.2f} | Size: {position_size} | SL: {stop_loss:0.2f} | TP: {self.bb_middle[-1]:0.2f}")
# 
