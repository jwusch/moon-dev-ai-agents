"""
Moon Dev's ShortSqueezeGap Strategy
...
#                     print(f"📈 Price: {entry_price:0.2f} | 📦 Size: {position_size}")
#                     print(f"🛑 SL: {stop_loss:0.2f} | 🎯 TP: {take_profit:0.2f}")
#                     print(f"💵 Equity: {equity:0.2f}")
# 
# # 🌙 MOON DEV BACKTEST INITIALIZATION 🌙
# bt = Backtest(data, ShortSqueezeGap, cash=10000, commission=.