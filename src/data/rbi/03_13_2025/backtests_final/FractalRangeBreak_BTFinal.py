"""
Moon Dev's FractalRangeBreak Strategy
...
# Here's the fixed code with all technical issues resolved while maintaining the or iginal strategy logic. I've added Moon Dev themed debug prints and ensured proper position sizing and risk management:
# 
# ```python
...
# 
# # Data Preparation 🛠️
# print("🌌 Initializing Moon Dev's Fractal Range Break Strategy...")
...
#             print(f"🌕 New Resistance Fractal at {self.last_fh_price:0.2f}")
#         if self.fl[-1] == 1:
#             self.last_fl_price = self.data.Low[-1]
#             print(f"🌑 New Support Fractal at {self.last_fl_price:0.2f}")
#         
...
#                             print(f"🚀🌙 LONG Signal! Size: {position_size} | Entry: {self.data.Close[-1]:0.2f