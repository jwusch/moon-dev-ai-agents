"""
Moon Dev's VolumeSurgeBreakout Strategy
...
#                 print(f"🌙✨ BUY SIGNAL | Size: {position_size} | Entry: {entry_price:0.2f} 🚀")
# 
#         # 🛑 Exit Management
...
#                     if new_sl > trade.sl:
#                         trade.sl = new_sl
#                         print(f"🌙🔧 Trailing SL Updated: {new_sl:0.2f}")
# 
...
#                 print(f"🌙💰 Profit Taken | PnL: {trade.pnl:0.2f}")
# 
# # 🚨 Backtest Execution
# bt = Backtest(data, VolumeSurgeBreakout, cash=10000, commission=0.002)
# stats = bt.run()
# print("🌙✨ Backtest