# 🌙 Moon Dev TrendBandRSIFinal.py Strategy
# Trend following with Bollinger Band RSI
...
class TrendBandRSIFinal(Strategy):
    # Strategy parameters
    ...
    def next(self):
        ...
        if not self.position:
            # 🚀 Entry Logic: RSI extremes within Bollinger Band context
...
# 🚀 Run backtest
bt = Backtest(data, TrendBandRSIFinal, cash=1_000_000, commission=0.002)
stats = bt.run()

# 🌕 Print results
print("\n🌕 MOON DEV TRENDBANDRSIFINAL RESULTS 🌕")
print("="*50)
