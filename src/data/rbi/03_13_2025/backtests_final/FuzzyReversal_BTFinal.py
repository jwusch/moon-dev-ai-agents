"""
Moon Dev's FuzzyReversal Strategy
...
#                         print(f"🌕 MOON SHOT! LONG @ {current_price:0.2f} | Size: {position_size} | SL: {sl:0.2f} | TP: {current_price + 2*risk_per_share:0.2f} 🚀")
#                         
#             elif bearish_cond:
...
#                     position_size = int(round((self.risk_pct * self.equity) / risk_per_share))
#                     if position_size > 0:
#                         self.sell(size=position_size, sl=sl, tp=current_price - 2*risk_per_share