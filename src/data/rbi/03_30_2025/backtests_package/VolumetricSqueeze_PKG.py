...
#         
#         # BB Width extremes
#         self.bbw_max = self.I(talib.MAX, bb_width, 100, name='BBW_MAX')
#         self.bbw_min = self.I(talib.MIN, bb_width, 100, name='BBW_MIN')
#         
#         # Parabolic SAR
#         self.sar = self.I(talib.SAR, high, low, acceleration=0.02, maximum=0.2, name='SAR')
#         
#         # Swing Low
#         self.swing_low = self.I(talib.MIN, low, timeperiod=20, name='Swing Low')
#         
#         print("🌙 VolumetricSqueeze initialized with Moon Dev power! 🚀")
#         print("✨ Indicators ready for lunar trading missions:")
#         print(f"   - Klinger Oscillator (34/55/13)")
#         print(f"   - Bollinger Bands (20,2)")
#         print(f"   - Parabolic SAR (0.02,0.2)")
#         print(f"   - Swing Lows (20 periods)")
# 
#     def next(self):
...
#             # Entry conditions
#             kvo_cross = (self.kvo_line[-2] < self.signal_line[-2] and 
#                          self.kvo_line[-1] > self.signal_line[-1])  # Bullish crossover
#             
...
#                     
#                     if position_size > 0:
#                         print(f"🚀 MOON LAUNCH: Long {position_size} @ {current_close