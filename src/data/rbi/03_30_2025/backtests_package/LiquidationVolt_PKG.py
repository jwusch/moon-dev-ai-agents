...
class LiquidationVolt(Strategy):
    ...
    def init(self):
        ...
        self.long_liq_avg = self.I(talib.SMA, self.data['long_liq'], timeperiod=20)
        self.short_liq_avg = self.I(talib.SMA, self.data['short_liq'], timeperiod=20)
    ...
    def next(self):
        ...
        # 🌑 Moon Entry Logic - No crossover() used!
