...
#                         
#                         if size > 0:
#                             print(f"🌙 MOON DEV ALERT: LONG ENTRY at {entry_price:.2f} | Size: {size} ✨")
#                             print(f"🌙 Stop Loss set at {stop_loss:.2f} | Risk: {self.risk_pct*100}% of equity")
...
#                         
#                         if size > 0:
#                             print(f"🌙 MOON DEV ALERT: SHORT ENTRY at {entry_price:.2f} | Size: {size