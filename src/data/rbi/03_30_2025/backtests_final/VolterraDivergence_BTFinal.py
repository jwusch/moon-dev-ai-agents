"""
Moon Dev's VolterraDivergence Strategy
...
#             print(f"🚀 LONG ENTRY: {size} units @ {entry_price:.2f} | SL: {stop_price:.2f} 🌕")
# 
...
#             print(f"🌑 SHORT ENTRY: {size} units @ {entry_price:.2f} | SL: {stop_price:.2f} 🌕")
# 
#     def calc_position_size(self, risk_per_share, entry_price):
#         risk_amount = self.risk_pct * self.equity
#         size = risk_amount / risk_per_share
#         size = int(round(size))  # Ensure whole number of units 🌙
#         
