"""
Moon Dev's FractalDivergence Strategy
...
# Here's the implementation of the FractalDivergence strategy for backtesting.py:
# 
# ```python
# # -*- coding: utf-8 -*-
# import pandas as pd
...
#                     return
#                 
#                 position_size = int(round((self.equity * self.risk_pct) / risk_per