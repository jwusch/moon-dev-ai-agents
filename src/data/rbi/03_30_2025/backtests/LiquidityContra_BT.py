...
#         if crossunder(self.data.Low, self.swing_low):
...
#         elif crossover(self.data.High, self.swing_high):
...
#                   for i, bw in enumerate(self.bandwidth[-self.swing_period:-1], start=len(self.bandwidth)-self.swing_period-1))
#     
#     def _enter_long(self):
#         entry_price = self.data.Close[-1]
#         swing_low_level = self.swing_low[-2]
#         stop_loss = swing_low_level * 0.99
#         
#         risk_amount = self.