"""
Moon Dev's VolSqueezeReversion Strategy
...
# 
# 1. Fixed incomplete short entry logic
# 2. Added proper position sizing calculations for both long and short
# 3. Ensured all print statements have Moon Dev theme
# 4. Fixed missing imports and dependencies
# 5. Added proper exit conditions
# 
...
#               self.bb_width[-1] < self.bb_width_avg[-1] and
#               self.data.Close[-1] < self.lower_2sigma[-1]