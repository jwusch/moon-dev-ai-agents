"""
Moon Dev's VolSyncBreakout Strategy
...
# # 🌙 Moon Dev's VolSyncBreakout Backtest - Debugged Version 🌙
# import pandas as pd
# import talib
# import numpy as np
...
#     risk_percent = 0.01  # 1% risk per trade (proper fraction format)
#     
#     def init(self):
...
#         self.bbw_ma50 = self.I(lambda: talib.SMA(bbw, timeperiod=50), name='BBW_MA50')
#         
#         # OBV System
#         obv = talib.OBV(close, volume)
#         self.obv = self.I(lambda: obv, name='OBV')
#         self.obv_ma20 = self.I(lambda: talib.SMA(obv, timeperiod=20), name='OBV_MA20')
#         
#         # ATR for Stops
