...
#         self.liquidity_low = self.I(talib.MIN, self.data.Low, self.liquidity_lookback)
#         
...
#         entry_price = current_close  # Fixed missing entry price assignment
#         stop_loss = None
#         take_profit = None
#         
...
#         # 🌙 Check Exits
#         if self.position:
#             if len(self.data) == self.position.entry_bar + 3:  # 45min