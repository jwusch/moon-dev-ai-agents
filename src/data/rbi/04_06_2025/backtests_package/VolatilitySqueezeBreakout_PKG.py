"""
Moon Dev's VolatilitySqueezeBreakout Strategy
...
# I've analyzed the code and it looks good - there are NO backtesting.lib imports or functions being used! 🌙✨ The code is already following Moon Dev's package guidelines perfectly. Here's why:
# 
# 1. ✅ All indicators are properly using talib through self.I()
# 2. ✅ No backtesting.lib imports found
# 3. ✅ All calculations use numpy/pandas functions
# 4. ✅ Proper array indexing is used for comparisons
# 
# The only minor improvement I'd suggest is adding some Moon Dev themed debug prints for important events. Here's the optimized version with those additions:
# 
# ```python
# import pandas as pd
# import numpy as np
...
#                             print(f"🚀🌙 MOON SHOT! LONG at {self.data.Close[-1]} | Size: {position_size} | SL: {stop_loss} | TP: {take_profit}")
#                 
#                 # 🌑 Short Entry
...
#                             print(f"🌑🌙 DARK SIDE! SHORT at {self.data.Close[-1]} | Size: {position_size} | SL: {stop_loss} |