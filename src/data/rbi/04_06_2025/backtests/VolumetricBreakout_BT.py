...
#         self.volume_ma = self.I(talib.SMA, self.data.Volume, 20, name='VOL_MA_20')
...
#             lambda c,h,l: talib.SMA(c,20) + 2.5*talib.ATR(h,l,c,14),
...
#                 print(f"🌙🌟 [CLOSE SHORT] RSI Rise {rsi_prev:.1f}→{rsi_now:.1f}")
#                 self.position.close()
# 
