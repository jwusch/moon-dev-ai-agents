...
#                     print(f"🌙✨ Lunar BUY Signal! | Size: {position_size} | Entry: {current_price:.2f} | SL: {sl:.2f} | TP: {tp:.2f}")
# 
#             # Short entry
...
#                     print(f"🌙✨ Cosmic SELL Signal! | Size: {position_size} | Entry: {current_price:.2f} | SL: {sl:.2f} | TP: {tp:.2f}")
# 
#         # Moon Dev Exit Logic 🌑
#         else:
#             if self.position.is_long and (self.cvd[-1] < self.cvd[-2] or self.stoch