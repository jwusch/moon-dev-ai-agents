"""
Moon Dev's VolumeReversal Strategy
...
#             print(f"🚀 MOON DEV SHORT! 🌑 | Entry: {price:.2f} | Size: {position_size} | SL: {stop_price:.2f} | TP: {fib_exit:.2f}")
# 
#         elif rsi < 30 and vol_surge > bbw: