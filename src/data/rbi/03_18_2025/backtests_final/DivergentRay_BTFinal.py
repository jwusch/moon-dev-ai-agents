"""
Moon Dev's DivergentRay Strategy
...
# The code you've provided is already in good shape, but I'll ensure it meets all technical requirements and add some Moon Dev-themed debug prints for better clarity. Here's the fully debugged and enhanced version:
# 
# ```python
# import pandas as pd
# import numpy as np
