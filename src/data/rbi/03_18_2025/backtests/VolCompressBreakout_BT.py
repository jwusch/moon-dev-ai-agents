...
#         self.middle = self.I(talib.SMA, self.data.Close, 20)
...
#         self.bb_width_min = self.I(talib.MIN, self.bb_width, 17280)  # 6 months 15m data
#         
#         # Volume confirmation
...
#             current_stop = min(self.position.tag['stop'], self.upper[-1])
