"""
Moon Dev's RapidReversal Strategy
...
#                     self.trades_today += 1
#                     print(f"🚀 MOON SHOT! Entry: {entry_price:0.2f} | Size: {position_size} | SL: {stop_loss:0.2f} | TP: {take_profit:0.2f} 🌌")
# 
#         # Exit Logic 🌗
#         else:
#             # RSI Exit Condition
...
#                 self.position.close()
#                 print(f"🌑 DARK MOON EXIT! RSI Crossed 50 | Price: {self.data.Close[-1]:0.2f} | P/L: {self.position.pl:0.2f} 💸")
# 
...
# 
# # Launch Moon Mission 🚀🌙
# bt = Backtest(data, RapidReversal, cash=1_000_000, commission=0.002)
# stats = bt.run()
# print("\n🌕🌖🌗🌘🌑