"""
Moon Dev's FibroOscillator Strategy
...
#         debug_msg = f"🌙 {self.data.index[-1]} | Price: {close:0.2f} | Trend: {trend}"
#         debug_msg += f"\n   RSI: {self.rsi[-1]:0.1f} | Swing High: {swing_high:0.2f} | Swing Low: {swing_low:0.2f}"
#         print(debug_msg)
# 
...
#             trade_msg = f"🚀🌕 BULLISH IMPACT! Entry: {entry_price:0.2f}"
#         else:
