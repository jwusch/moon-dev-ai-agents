"""
Moon Dev's StochasticArbitrage Strategy
...
#         
#         exit_conditions = (
#             crossover(self.stoch_k, 50) or
#             crossunder(self.stoch_k, 50) or
#             abs(self.z_score[-1]) < 0.5 or
#             (self.position.is_long and current_close >= self.bb_middle[-1]) or
#             (self.position.is_short and current_close <= self.bb_middle