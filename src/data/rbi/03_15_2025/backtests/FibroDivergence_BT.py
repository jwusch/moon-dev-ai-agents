...
#             bullish_div = True
#             print(f"🌙✨ Bullish divergence detected! RSI: {self.rsi[-3]:0.1f}→{self.rsi[-1]:0.1f} Price: {self.data.Low[-3]:0.1f}→{self.data.Low[-1]:0.1f}")
#         
...
#             bearish_div = True
#             print(f"🌙✨ Bearish divergence detected! RSI: {self.rsi[-3]:0.1f}→{self.rsi[-1]:0.1f} Price: {self.data.High[-3]:0.1f}→{self.data.High[-1]:0.1f}")
#         
...
#                     print(f"🚀🌙 LONG launched! Size: {position_size} | Entry: {price:0.2f} | SL: {sl:0.2f} |