"""
Moon Dev's StochasticBreakout Strategy
...
#             print(f"🌙✨ Moon Dev LONG Signal! 🚀 Entry: {entry_price:0.2f}")
#             print(f"   Size: {position_size}, SL: {stop_level:0.2f}, TP: {take_profit:0.2f}")
# 
...
#             print(f"🌙✨ Moon Dev SHORT Signal! 🌧️ Entry: {entry_price:0.2f}")
#             print(f"   Size: {position_size}, SL: {stop_level:0.2f}, TP: {take_profit:0.2f}")
# 
