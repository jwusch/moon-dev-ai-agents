"""
Moon Dev's MomentumSwapSpread Strategy
...
#                     self.position.close()
#                     print(f"🌙 Closing LONG | RSI: {current_rsi:0.1f} | "
#                           f"Spread: {current_spread:0.2f} → Hist: {hist_spread:0.2f} ✨")
# 
...
#                     self.position.close()
#                     print(f"🌑 Closing SHORT | RSI: {current_rsi:0.1f} | "
#                           f"Spread: {current_spread:0.2f} → Hist: {hist_spread:0.2f} 🌌")
# 
#         # 🌟 Open new positions
...
#                 print(f"🚀 MOON BULLISH | Entry: {price:0.2f} | "
#                       f"RSI: {current_rsi:0.1f} | Size: {position_size} 🌕")
# 
...
#                 print(f"🌑 MOON BEARISH | Entry: {price:0.2f} | "
#                       f"RSI: {current_rsi:0.1f} | Size: {position_size} 🌘")
# 
# # 🌍 Data Preparation
