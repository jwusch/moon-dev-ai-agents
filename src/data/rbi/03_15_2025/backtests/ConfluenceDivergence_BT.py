# 🌙 Moon Dev ConfluenceDivergence.py Strategy
# ConfluenceDivergence_BT trading strategy
...
# 🚀 Run backtest
bt = Backtest(data, ConfluenceDivergence, cash=1_000_000, commission=0.002)
stats = bt.run()

# 🌕 Print results
print("\n🌕 MOON DEV CONFLUENCEDIVERGENCE RESULTS 🌕")
print("="*50)
