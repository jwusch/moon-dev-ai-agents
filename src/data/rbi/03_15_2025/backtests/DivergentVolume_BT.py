...
#         print(f"Close: {self.data.Close[-1]:0.2f}, EMA50: {self.ema50[-1]:0.2f}")
#         print(f"MACD Hist: {self.macd_hist[-1]:0.4f}, Vol Ratio: {self.volume_ratio[-1]:0.2f}")
#         
...
#                         print(f"🚀 LONG ENTRY: {position_size} shares @ {self.data.Close[-1]:0.2f}")
#                         print(f"🎯 TP: {self.data.Close[-1] + 3*atr_value:0.2f}, 🛑 SL: {stop_loss:0.2f}")
#         else:
