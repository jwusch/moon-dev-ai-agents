"""
Moon Dev's VolumeMACDDivergence Strategy
...
#             macd_above = crossover(self.macd_line, self.signal_line)
...
#             macd_below = crossover(-self.macd_line, -self.signal_line)
...
#                 if crossover(-self.macd_line, -self.signal_line) or bearish_divergence:
#                     self.position.close()
#                     print(f"🌕✨ MOON DEV LONG EXIT! Price: {current_close} | Reason: {'Divergence' if bearish_divergence else 'MACD Cross'}")
# 
