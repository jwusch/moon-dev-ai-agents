...
class FractalVolatility(Strategy):
    ...
    def init(self):
        ...
        self.atr_sma = self.I(talib.SMA, self.atr, 14, name='ATR_SMA_14')
        
        # Fractal detection indicators
        self.max_high = self.I(talib.MAX, self.data.High, 5, name='FRACTAL_HIGH')
        self.min_low = self.I(talib.MIN, self.data.Low, 5, name='FRACTAL_LOW')
