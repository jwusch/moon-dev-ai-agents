"""
Moon Dev's NocturnalReversal Strategy
...
#             print(f"🌙⚠️ Black Hole Alert! SL too wide: {risk_distance/entry_price*100:0.1f}%")
#             return
# 
...
#         if self.position and self.data.Low[-1] < self.bb_l