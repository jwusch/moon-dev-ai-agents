"""
Moon Dev's BandedMeanTarget Strategy
...
#                         print(f"🌙✨ MOON DEV ENTRY! Buying {position_size} @ {entry_price:0.2f} 🚀")
# 
...
#                 self.position.close()
#                 print(f"🌕💎 PROFIT TAKEN @ {tp_price:0.2f}! MOON MISSION SUCCESS! 💰")
# 
...
#                 self.position.close()
#                 print(f"🌑🛡️ STOP LOSS HIT @ {new_stop:0.2f}! PROTECTING MOON BASE! 🛡️