# 🌙 Moon Dev FractalDivergence.py Strategy
# FractalDivergence_BT trading strategy
...
# 🚀 Run backtest
bt = Backtest(data, FractalDivergence, cash=1_000_000, commission=0.002)
stats = bt.run()

# 🌕 Print results
print("\n🌕 MOON DEV FRACTALDIVERGENCE RESULTS 🌕")
print("="*50)
