"""
Moon Dev's VolatilityYieldDivergence Strategy
...
#         
#         momentum_buy = (self.rsi[-1] < 30) or crossover(self.macd, self.macdsignal)
# 
...
#                 print(f"🌙🚀 MOON DEV ALERT: LONG {position_size} @ {price:0.2f} | SL {stop_price:0.2f} 🚀🌙")
# 
#         # 🌙✨ EXIT CONDITIONS ✨🌙
...
#                     self.sell()
#                     print(f"🌙🌌 COSMIC EXIT: {self.data.Close[-1]:0.2f} | PROFIT {trade.pl:0.2f} 🌌🌙")
# 
# # ================
# # BACKTEST EXECUTION
# # ================
