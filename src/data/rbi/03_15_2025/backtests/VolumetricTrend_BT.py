    ...
    def next(self):
        ...
        if not self.position:
            ...
            if (sma10_prev <= sma50_prev) and (sma10_now > sma50_now) and (volume_now > vol_avg_now):
                ...
                if position_size > 0:
                    ...
                    print(f"    Size: {position_size} BTC | Risk: {self.risk_percent*100}% | ATR Stop: {risk_per_unit:0.2f}")
        ...
        # Exit Logic 🛑
            ...
            if not hasattr(self, 'entry_atr'):
                ...
                print(f" POSITION ACTIVE | Entry: {self.entry_price} | ATR: {self.entry_atr:0.2f}")
