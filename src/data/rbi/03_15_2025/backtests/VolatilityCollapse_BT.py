"""
Moon Dev's VolatilityCollapse Strategy
...
#                             sl=stop_loss,
#                             tp=price + tp_pct)
#                     print(f"🌕✨ MOON DEV LONG SIGNAL! Entry: {price:0.2f}, Size: {position_size} BTC, Risk: {risk_per_share:0.2f} USD")
# 
#             # 🌑 SHORT ENTRY SIGNAL
...
#                              sl=stop_loss,
#                              tp=price - tp_pct)
#                     print(f"🌑✨ MOON DEV SHORT SIGNAL! Entry: {price:0.2f}, Size: {position_size} BTC, Risk: {risk_per_share:0.2f} USD")
# 
