# 🌙 Moon Dev FibStochTrend.py Strategy
# FibStochTrend_BT trading strategy
...
# 🚀 Run backtest
bt = Backtest(data, FibStochTrend, cash=1_000_000, commission=0.002)
stats = bt.run()

# 🌕 Print results
print("\n🌕 MOON DEV FIBSTOCHTREND RESULTS 🌕")
print("="*50)
