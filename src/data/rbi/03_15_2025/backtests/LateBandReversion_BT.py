...
# Here's the complete backtesting implementation for the LateBandReversion strategy:
# 
# ```python
# import pandas as pd
# import talib
...
#                 self.sell(size=size, 
#                          sl=sl_price,
#                          tag=f'Short | SL: {sl_price:0.2f}')
#                 self.trade_count['short'] += 1
#                 print(f"🌙🚀 SHORT ENTRY! {entry_price:0.2f} | Size: {size} BTC")
#             
...
#                 self.buy(size=size,
#                         sl=sl_price,
#                         tag=f'Long | SL: {sl_price:0.2f}')
#                 self.trade_count['long'] += 1
#                 print(f"🌙🌕 LONG ENTRY! {entry_price:0.2f} | Size: {size} BTC")
#         
#         # Exit logic
...
#                     trade.close()
#                     print(f"🌙✨ SHORT EXIT | Profit: {trade.pl_pct:0.2f}%")
#                     
#             elif trade.is_long:
#                 # Close long if price closes above lower band
#                 if self.data.Close[-1] > self.lower[-1]:
#                     trade.close()
#                     print(f"🌙✨ LONG EXIT | Profit: {trade.pl_pct