...
#         print(f"🌙 [{self.data.index[-1]}] Close: {current_close:0.2f} | %K: {current_k:0.2f} | %D: {current_d:0.2f} ✨")
#         
...
#                     print(f"🚨 Closing LONG at {current_close:0.2f} (Stochastic exit)")
#                     self.position.close()
#             elif self.position.is_short:
#                 if crossover(current_k, current_d) and (current_k < 20):
#                     print(f"🚨 Closing SHORT at {current_close:0.2f} (Stochastic exit)")
#                     self.position.close()
#                     
#     def enter_long(self):
