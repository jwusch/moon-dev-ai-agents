...
#                     
#                     if position_size > 0:
#                         print(f"🌙✨🚀 MOON DEV ENTRY SIGNAL! Buying {position_size} @ {entry_price:0.2f}")
...
#             # RSI Exit
#             if self.rsi[-1] > 70:
#                 print(f"🌙✨💎 RSI EXIT @ {self.data.Close[-1]:0.2f}")
#                 exit_trade = True
#                 
#             # DI Reversal Exit
#             if len(self.di) > 1:
...
#                 if di_reversal:
#                     print(f"🌙✨💎 DI REVERSAL EXIT @ {self.data.Close[-1]:0.2f}")
#                     exit_trade = True
#                     
