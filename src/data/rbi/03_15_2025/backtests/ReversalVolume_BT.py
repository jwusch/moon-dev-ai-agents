"""
Moon Dev's ReversalVolume Strategy
...
#             print(f"   RSI: {self.rsi[-1]:0.2f}, Volume: {self.data.Volume[-1]:0.2f} (MA: {self.volume_ma[-1]:0.2f}) 🚀")
# 
#         # Entry trigger check 🔥
...
#                 
#                 # 🚀 Execute trade with OCO or ders
#                 self.buy(size=position_size,
#                         sl=stop_loss,
#                         tp=take_profit)
#                 
#                 print(f"🌕🚀 MOON DEV ENTRY! Long {position_size} units @ {entry_price:0.2f}")
#                 print(f"   SL: {stop_loss:0.2f} | TP: {take_profit:0.2f} | R/R: 1:2 🔥