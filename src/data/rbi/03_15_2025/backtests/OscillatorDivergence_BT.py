# 🌙 Moon Dev OscillatorDivergence.py Strategy
# OscillatorDivergence_BT trading strategy
...
# 🚀 Run backtest
bt = Backtest(data, OscillatorDivergence, cash=1_000_000, commission=0.002)
stats = bt.run()

# 🌕 Print results
print("\n🌕 MOON DEV OSCILLATORDIVERGENCE RESULTS 🌕")
print("="*50)
