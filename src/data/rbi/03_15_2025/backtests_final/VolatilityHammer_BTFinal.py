"""
Moon Dev's VolatilityHammer Strategy
...
# I'll help debug the code while maintaining the strategy logic. Here's the fixed version with Moon Dev themed debug prints:
# 
# ```python
...
#     print("🌑 MOON DEV ERROR: Data file not found! Please check the file path.")
#     exit()
# 
# # Clean column names 🧹
...
# except KeyError:
#     print("🌑 MOON DEV ERROR: 'datetime' column not found in data!")
#     exit()
# 
...
#             risk_per_unit = abs(self.data.Close[-1] - sl)  # Added abs() for safety
#             if risk_per_unit <= 0:
#                 print("🌑 MOON DEV WARNING: Invalid risk detected, skipping trade")
