"""
Moon Dev's YieldCurveReversal Strategy
...
# required_columns = ['vix_futures_30d', 'treasury_3m']
# for col in required_columns:
#     if col not in data.columns:
#         raise ValueError(f"🌑 Missing cosmic data: {col} not found in dataset! 🚨")
# 
...
#                     print(f"   Size: {position_size} units | SL: {sl_price:.2f} | TP: {tp_price:.2f}")
