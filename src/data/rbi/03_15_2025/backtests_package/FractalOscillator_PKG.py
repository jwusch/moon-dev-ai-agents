"""
Moon Dev's LunarPulseStrategy Strategy
...
#         sma_crossover = (self.sma_fast[-2] < self.sma_slow[-2] and self.sma_fast[-1] > self.sma_slow[-1])
#         sma_crossunder = (self.sma_fast[-2] > self.sma_slow[-2] and self.sma_fast[-1] < self.sma_slow[-1])
