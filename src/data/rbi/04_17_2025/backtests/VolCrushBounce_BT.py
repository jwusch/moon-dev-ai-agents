"""
Moon Dev's VolCrushBounce Strategy
...
#         self.bb_lower = self.I(lambda close: talib.BBANDS(close, timeperiod=20, nbdevdn=2)[2], self.data.Close, name='BB_LOWER')
...
# 
# # 🌙 Backtest Execution
# bt = Backtest(data, VolCrushBounce, cash=1_000_