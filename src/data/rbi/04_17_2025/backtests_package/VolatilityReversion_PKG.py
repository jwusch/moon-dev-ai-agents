...
#             return
# 
#         # 🌑 CURRENT STAR ALIGNMENTS (replaced crossovers)
#         entry_signal = (self.hv_10_ma20[-2] < self.hv_10[-2]) and (self.hv_10_ma20[-1] > self.hv_10[-1])  # Bullish crossover replacement
#         exit_signal = (self.rsi_5[-2] < 70) and (self.rsi_5[-1] > 70)  # Bearish crossover replacement
