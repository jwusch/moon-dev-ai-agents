"""
Moon Dev's SqueezeReversal Strategy
...
#         self.oi_low = self.I(talib.MIN, self.data.df['openinterest'], 96, name='OI_LOW_24H')
...
#             and len(self.positions) < self.max_positions and not self.position):
#             
