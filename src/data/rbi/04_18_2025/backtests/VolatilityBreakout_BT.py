...
#         ema_bullish = crossover(self.ema_fast, self.ema_slow)
#         
...
#                 print(f"⏰ MISSION DURATION EXIT | Bars Held: {len(self.data) - self.position.entry_bar}")
# 
# # ========================
# # BACKTEST EXECUTION
# # ========================
# bt = Backtest(data, VolatilityBreakout, 
#              cash=1_