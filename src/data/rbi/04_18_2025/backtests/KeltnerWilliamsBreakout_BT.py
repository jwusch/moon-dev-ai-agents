"""
Moon Dev's KeltnerWilliamsBreakout Strategy
...
#         
#         # Bollinger Bands
#         self.bb_upper, _, self.bb_lower = self.I(talib.BBANDS, self.data.Close, 20, 2, 2, multiple=True)
#         
#         # Volatility filter
...
#             # Entry conditions
#             willr_cross = crossover(self.willr, -80)
...
# 
# # Run backtest
# bt = Backtest(data, KeltnerWilliamsBreakout, cash=1_000_000, commission=.002)
# stats = bt.run()
# print(stats)
# print(st