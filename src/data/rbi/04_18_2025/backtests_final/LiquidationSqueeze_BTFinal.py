...
# I'll analyze and debug this code while maintaining the original strategy logic. Here's the fixed version with Moon Dev themed improvements:
# 
# ```python
# import pandas as pd
...
# 
# # Clean and format columns - Moon Dev style ✨
...
#                             print(f"🌙✨ MOON LIFT-OFF! LONG {size} units at {current_close:.2f} 🚀")
#                             print(f"🌌 Stellar stop at {sl_price:.2f} | Target orbit {tp