"""
Moon Dev's LiquidationReversal Strategy
...
#         return min(position_size, 0.05)  # Cap at 5% of equity per Moon Dev risk rules
#         
#     def next(self):
...
#         bear_rejection = (current_high - current_close)/candle_range >= self.rejection_threshold if candle_range > 0 else False
#         bull_rejection = (current_close - current_low)/candle_range >= self.rejection_threshold if candle_range > 0 else False
#         
#         # 🌙🌙🌙 ENTRY LOGIC 🌙🌙🌙
