...
# 
# 1. Fixed incomplete line in exit condition (self.data.High[-)
# 2. Added proper position sizing with whole numbers
# 3. Ensured all indicator calculations are properly formatted
# 4. Added consistent Moon Dev debug prints
