...
#                     print(f"🚀 LIFT OFF! | Size: {position_size} | Entry: {self.data.Close[-1]:.2f} | ATR: {atr_value:.2f}")
# 
#         # 🔥 EXIT LOGIC
#         if self.position:
...
#                 print(f"🔻 LANDING SEQUENCE | Price: {self.data.Close[-1]:.2f} | Trail Stop: {trail_stop:.2f}")
# 
