...
#             cmo_up = (self.cmo[-2] < self.cmo_signal[-2]) and (self.cmo[-1] > self.cmo_signal[-1])  # Bullish crossover replacement
...
#             cmo_down = (self.cmo_signal[-2] < self.cmo[-2]) and (self.cmo_signal[-1] > self.cmo[-1])  # Bearish crossover replacement
