...
#         lower_kc = ema - 2*atr
#         
#         # Strategy conditions - using direct array comparisons
...
#             print(f"🌕 MOON ALERT: OBV 20-day HIGH! Current: {self.obv[-1]:.2f}, High: {self.obv_20_high[-1]:.2f}")
#         if squeeze_condition:
#             print(f"✨ SQUEEZE DETECTED! Width: {self.kc_width[-1]:.2f} < Avg: {self.avg_kc_width[-1]:.2f}")
#         
#         # Entry logic
...
#                         print(f"🚀 LIFT OFF! LONG ENTRY @ {current_close:.2f}, Size: {position_size}, SL: {sl_price:.2f}")
#                 
#                 # Short entry
...
#                         print(f"🌑 DARK SIDE ENTRY @ {current_close:.2f}, Size: {position_size}, SL: {sl_price:.