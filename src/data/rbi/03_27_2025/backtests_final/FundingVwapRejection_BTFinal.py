"""
Moon Dev's FundingVwapRejection Strategy
...
#     entry_funding = 0.001  # 0.1% funding rate threshold
#     exit_funding = 0.0005  # 0.05% exit threshold
#     emergency_funding = 0.003  # 0.3% emergency threshold
#     
#     def init(self):
