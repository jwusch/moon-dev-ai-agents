"""
Moon Dev's LiquiSqueeze Strategy
...
#                         size=position_size, 
#                         sl=stop_loss,
#                         tp=price + (bb_upper - bb_lower) * self.tp_multiplier,
#                         tag={
#                             'squeeze_range': bb_upper - bb_lower,
#                             'entry_type': 'long'
#                         }
#                     )
#                     print(f"🌙 MOON ALERT: LONG ENTRY @ {price:.2f} | Size: {position_size} | SL: {stop_loss:.2f} | TP: {price + (bb_upper - bb_lower) * self.tp_multiplier:.2f} ✨")
# 
#             # Short Entry Logic 🌑
...
#                 
#                 stop_loss = bb_upper
#                 risk_pct = self.max_risk_pct if self._near