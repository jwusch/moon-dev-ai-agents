...
#         raise ValueError(f"🌌 Cosmic Error! Missing required column: {col}")
# 
...
#         print("🌕 Lunar Indicators Initialized! Ready for launch sequence...")
# 
#     def next(self):
#         if self.position:
...
#                     print("⚠️ Invalid SL Price - Aborting Launch Sequence")
#                     self.entry_flag = False
#                     return
#                 
...
#                     print(f"   Entry: {entry_price:.2f} | SL: {sl_price:.2f} | TP: {tp_price