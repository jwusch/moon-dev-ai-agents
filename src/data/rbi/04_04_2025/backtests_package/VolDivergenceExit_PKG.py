"""
Moon Dev's VolDivergenceExit Strategy
...
#             hv_cross = (self.data.HV_10[-2] >= self.data.HV_30_Avg[-2] and 
#                        self.data.HV_10[-1] < self.data.HV_30_Avg[-1])
#             
...
#             
#             # Volatility exit condition - replaced crossover with direct comparison
#             elif (self.data.HV_10[-2] <= self.data.HV_30_Avg[-2] and 
#                  self.data.HV_10[-1] > self.data.HV_30_Avg[-1]):
