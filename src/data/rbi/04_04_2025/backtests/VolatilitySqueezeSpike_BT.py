"""
Moon Dev's VolatilitySqueezeSpike Strategy
...
#         self.bbw_low = self.I(talib.MIN, self.bbw, timeperiod=10, name='BBW_10_LOW')
#         
#         # Volume MA
#         self.vol_ma = self.I(talib.SMA, volume, timeperiod=20, name='VOL_MA20')
#         
#         # Keltner Components
...
#             
#             # Volume spike check
#             volume_spike = current_volume > self.vol_ma[-1]
#             
...
#             
#             if self.position.is_long and current_close > keltner_upper:
#                 print(f"🎯 MOON DEV LONG EXIT 🎯 | Price: {current_close:.2f} vs Keltner {keltner_upper:.2f}")
#                 self.position.close()
#             elif self.position.is_short and current_close < keltner_lower