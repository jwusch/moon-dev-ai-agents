"""
Moon Dev's ExtremeFundingReversal Strategy
...
#         self.fund_mean = self.I(talib.SMA, fr, 2880)  # 30-day mean
#         self.fund_std = self.I(talib.STDDEV, fr, 2880)  # 30-day std
...
#         self.vol_ma = self.I(talib.SMA, self.data.Volume, 1344)  # 14-day MA
#         self.atr = self.I(talib.ATR, self.data.High, self.data.Low, 
#                          self.data.Close, 14)  # 14-period ATR
#         
#     def next(self):
#         # Current values ✨
