"""
Moon Dev's ChaikinDivergenceBreakout Strategy
...
#             macd, macdsignal, hist = talib.MACD(close, 12, 26, 9)
#             return hist
...
#                     print(f"🌙✨🚀 LONG ENTRY @ {current_close:.2f} | CMF: {self.cmf[-1]:.2f} | MACD Divergence Confirmed!")
#         
#         # 🌑 Short Entry Logic
#         if not self.position:
...
#             divergence_bear = price_higher_high and hist_lower_high
#             
#             # Breakdown Confirmation ✨
#             swing_break = current_close < self.swing_low[-