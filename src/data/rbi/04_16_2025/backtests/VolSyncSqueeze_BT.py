"""
Moon Dev's VolSyncSqueeze Strategy
...
#         self.bb_middle = self.I(talib.SMA, self.data.Close, 20, name='BB Middle')
#         self.bb_stddev = self.I(talib.STDDEV, self.data.Close, 20, name='BB StdDev')
...
#         self.bb_bandwidth_low = self.I(talib.MIN, self.bb_bandwidth, 10, name='BB Band Low')
#         
#         # OBV and Swing Lows 🌙🌊
#         self.obv = self.I(talib.OBV, self.data.Close, self.data.Volume, name='OBV')
#         self.price_low = self.I(talib.MIN, self.data.Low, 5, name='Price Swing Low')
#         self.obv_low = self.I(talib.MIN, self.obv, 5, name='OBV Swing Low')
#         
