"""
Moon Dev's VortexReversion Strategy
...
#                     self.take_profit = current_close - 1.5 * atr_value
#                     print(f"🚀🌑 SHORT ENTRY! Size: {position_size} | Entry: {current_close} | SL: {stop_loss} | TP: {self.take_profit}")
# 
#             # Long Entry Conditions
#             elif (self.vi_minus[-1] > self.