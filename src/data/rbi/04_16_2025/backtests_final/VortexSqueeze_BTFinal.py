...
class VortexSqueeze(Strategy):
    ...
    def init(self):
        ...
        self.upper_bb, self.middle_bb, self.lower_bb = self.I(
            ...
            matype=0, name=['UPPER_BB', 'MIDDLE_BB', 'LOWER_BB']
        )
        ...
        self.vi_plus = self.I(vi_plus.values, name='VI_PLUS')
        self.vi_minus = self.I(vi_minus.values, name='VI_MINUS')
        ...
        bb_bandwidth = (self.upper_bb - self.lower_bb) / self.middle_bb
...
#                     print("🌙 MOON DEV WARNING: Invalid risk per share, skipping trade")
                ...
                position_size = int(round(position_size))  # Convert to