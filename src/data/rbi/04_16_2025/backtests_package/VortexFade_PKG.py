"""
Moon Dev's VortexFade Strategy
...
#         vi_bullish = (prev_vi_plus <= prev_vi_minus) and (vi_plus > vi_minus)  # 🌙 Bullish crossover
#         vi_bearish = (prev_vi_plus >= prev_vi_minus) and (vi_plus < vi_minus)  # 🌑 Bearish crossover
